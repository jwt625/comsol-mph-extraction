function out = model
%
% thin_film_baw_resonator_s_parameter.m
%
...
model.physics('es').feature('term2').set('TerminalType', 'Terminated');
model.physics('es').feature('term2').set('P0', 0.1);

model.study('std1').feature('eig').set('useadvanceddisable', true);
model.study('std1').feature('eig').set('disabledphysics', {'es/term2'});
model.study('std2').feature('freq').set('useadvanceddisable', true);
model.study('std2').feature('freq').set('disabledphysics', {'es/term2'});
model.study.create('std3');
model.study('std3').feature.copy('freq1', 'std2/freq');
model.study('std3').feature('freq1').set('useadvanceddisable', false);
...
model.sol('sol3').feature('s1').feature('p1').set('plistarr', {'range(215,0.1,235)[MHz]'});
...
model.sol('sol3').feature('s1').feature('p1').set('control', 'freq1');
model.sol('sol3').feature('s1').set('linpmethod', 'sol');
model.sol('sol3').feature('s1').set('linpsol', 'zero');
model.sol('sol3').feature('s1').set('control', 'freq1');
...
model.result('pg10').feature('str1').selection.set([5 6 7 12 13 14 16 19 24 25 26 29]);
...
model.result('pg11').feature('str1').selection.set([5 6 7 12 13 14 16 19 24 25 26 29]);
...
model.result('pg12').label('S-parameter');
...
model.result('pg12').feature('glob1').setIndex('expr', 'es.S22', 0);
model.result('pg12').feature('glob1').setIndex('descr', 'S-parameter', 0);
model.result('pg12').feature('glob1').setIndex('expr', 'imag(es.S22)', 1);
model.result('pg12').feature('glob1').setIndex('descr', 'Imaginary part', 1);

model.variable.create('var1');
model.variable('var1').model('comp1');
model.variable('var1').set('S11', '(1-es.Y11*50[ohm])/ (1+es.Y11*50[ohm])', 'S-parameter, 11-component');
model.variable('var1').descr('S11', 'S-param from Study 2');
...
model.result('pg12').feature('glob2').setIndex('expr', 'S11', 0);
model.result('pg12').feature('glob2').setIndex('expr', 'imag(S11)', 1);
model.result('pg12').feature('glob2').setIndex('descr', 'imaginary part', 1);
...
model.result('pg13').label('S-parameter, dB scale');
...
model.result('pg13').feature('glob1').setIndex('expr', 'es.S22dB', 0);
model.result('pg13').run;

model.title('S-Parameter of a Thin-Film BAW Resonator');

model.description('This model shows how to compute the S-parameter for a piezoelectric MEMS device by extending the tutorial Thin-Film BAW Composite Resonator. The measurement of S-parameter is commonly used to characterize such devices for RF applications. The terminal feature in the Electrostatics physics interface provides straightforward access to the computed S-parameters for frequency-domain study types.');
...
model.label('thin_film_baw_resonator_s_parameter.mph');
