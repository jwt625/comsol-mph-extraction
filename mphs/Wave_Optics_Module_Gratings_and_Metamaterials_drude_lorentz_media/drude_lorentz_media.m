...
model.physics('ewt').prop('components').set('components', 'inplane');
model.physics('ewt').feature('wee1').set('DisplacementFieldModel', 'DrudeLorentzDispersionModel');
model.physics('ewt').feature('wee1').set('epsilonInf', [4 0 0 0 4 0 0 0 1]);
model.physics('ewt').feature('wee1').set('omegap', 'omega_p');
model.physics('ewt').feature('wee1').set('mur_mat', 'userdef');
model.physics('ewt').feature('wee1').set('sigma_mat', 'userdef');
model.physics('ewt').feature('wee1').create('dlp1', 'DrudeLorentzPolarization', 2);
model.physics('ewt').feature('wee1').feature('dlp1').set('item.f', 1);
model.physics('ewt').feature('wee1').feature('dlp1').set('item.omega0', 'omega_1');
model.physics('ewt').feature('wee1').feature('dlp1').set('item.damp', 'gamma_1');
model.physics('ewt').create('wee2', 'WaveEquationElectric', 2);
model.physics('ewt').feature('wee2').selection.set([1 3 5]);
model.physics('ewt').feature('wee2').set('n_mat', 'userdef');
...
model.physics('ewt').feature('sctr1').set('E0i', {'0' 'E_pulse*E_bnd' '0'});
model.physics('ewt').create('sctr2', 'Scattering', 1);
model.physics('ewt').feature('sctr2').selection.set([16]);
model.physics('ewt').create('pc1', 'PeriodicCondition', 1);
model.physics('ewt').feature('pc1').selection.set([2 3 5 10 12 15]);
...
model.result('pg4').run;
model.result('pg4').feature('surf1').set('expr', 'ewt.Poscy');
model.result('pg4').run;
...
model.result('pg5').feature('surf1').set('expr', 'ewt.Hz');
model.result('pg5').feature('surf1').set('colortable', 'Cyclic');
model.result('pg5').run;
model.result('pg5').create('con1', 'Contour');
model.result('pg5').feature('con1').set('expr', 'ewt.Poscy');
model.result('pg5').run;
