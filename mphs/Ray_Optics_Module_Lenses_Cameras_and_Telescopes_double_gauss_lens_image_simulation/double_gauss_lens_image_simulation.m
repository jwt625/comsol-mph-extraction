function out = model
%
% double_gauss_lens_image_simulation.m
%
...
model.result.dataset('ip1').setIndex('genpnpoint', '1.0518029235925476E-6[mm]', 0);
model.result.dataset('ip1').setIndex('genpnpoint', '-2.8585104710464485E-6[mm]', 1);
model.result.dataset('ip1').setIndex('genpnpoint', '136.92789621155785[mm]', 2);
model.result.dataset('ip1').set('genpnvec', [0 0 1]);
model.result('pg3').feature('spot2').run;
model.result.dataset('ip1').set('genmethod', 'pointnormal');
model.result.dataset('ip1').setIndex('genpnpoint', '1.050088647195677E-6[mm]', 0);
model.result.dataset('ip1').setIndex('genpnpoint', '-2.8562619929438038E-6[mm]', 1);
model.result.dataset('ip1').setIndex('genpnpoint', '136.92789591563903[mm]', 2);
model.result.dataset('ip1').set('genpnvec', [0 0 1]);
...
model.result.dataset('ip2').setIndex('center', '1.0518029235925476E-6[mm]', 0);
model.result.dataset('ip2').setIndex('axis', '-0.0', 0);
model.result.dataset('ip2').setIndex('center', '-2.8585104710464485E-6[mm]', 1);
model.result.dataset('ip2').setIndex('axis', '-0.0', 1);
model.result.dataset('ip2').setIndex('center', '136.92789621155785[mm]', 2);
...
model.geom('geom1').feature('pi4').setEntry('inputexpr', 'd1', '0.80*d1_S');
model.geom('geom1').run;

model.physics('gop').create('relg2', 'ReleaseGrid', -1);
model.physics('gop').feature('relg2').setIndex('x0', '-1[m]', 2);
model.physics('gop').feature('relg2').set('RayDirectionVector', 'Conical');
model.physics('gop').feature('relg2').set('ConicalDistribution', 'Hexapolar');
model.physics('gop').feature('relg2').setIndex('Nctheta', 'N_ring', 0);
model.physics('gop').feature('relg2').set('cax', {'nix' 'niy' 'niz'});
model.physics('gop').feature('relg2').set('alphac', '0.70*atan(0.5*d1_clear_1/1[m])');

model.study('std1').feature('rtrac').set('llist', '0 1200');
model.study('std1').feature('rtrac').set('useadvanceddisable', true);
model.study('std1').feature('rtrac').set('disabledphysics', {'gop/relg1' 'gop/wall3'});
...
model.result.dataset('ip1').set('genmethod', 'pointnormal');
model.result.dataset('ip1').setIndex('genpnpoint', '3.7707420629817227E-6[mm]', 0);
model.result.dataset('ip1').setIndex('genpnpoint', '-4.0900827684410765E-6[mm]', 1);
model.result.dataset('ip1').setIndex('genpnpoint', '147.13295759123938[mm]', 2);
model.result.dataset('ip1').set('genpnvec', [0 0 1]);
model.result('pg3').set('ispendingzoom', true);
model.result('pg3').feature('spot2').run;
model.result('pg3').run;
...
model.result.dataset('ip2').setIndex('genpnpoint', '1.0518029235925476E-6[mm]', 0);
model.result.dataset('ip2').setIndex('genpnpoint', '-2.8585104710464485E-6[mm]', 1);
model.result.dataset('ip2').setIndex('genpnpoint', '136.92789621155785[mm]', 2);
model.result.dataset('ip2').set('genpnvec', {'-0.0' '-0.0' '-1.0'});
model.result.dataset('ip2').set('type', 'hemisphere');
model.result.dataset('ip2').setIndex('center', '3.770742073791655E-6[mm]', 0);
model.result.dataset('ip2').setIndex('axis', '-0.0', 0);
model.result.dataset('ip2').setIndex('center', '-4.090082773894825E-6[mm]', 1);
model.result.dataset('ip2').setIndex('axis', '-0.0', 1);
model.result.dataset('ip2').setIndex('center', '147.13295759124327[mm]', 2);
model.result.dataset('ip2').setIndex('axis', '-1.0', 2);
model.result.dataset('ip2').set('radius', '50[mm]');
...
model.param('par3').label('Parameters 3: Image Simulation');
model.param('par3').set('h_object', '400.0[mm]');
model.param('par3').descr('h_object', 'Object height');
model.param('par3').set('mag', '9.5');
model.param('par3').descr('mag', 'Approximate magnification');
model.param('par3').set('h_image', 'h_object/mag');
model.param('par3').descr('h_image', 'Image height');
model.param('par3').set('Z_focus', '147.124[mm]');
model.param('par3').descr('Z_focus', 'Finite conjugate focus');
model.param('par3').set('Nrays', '250e3');
model.param('par3').descr('Nrays', 'Total number of rays');
model.param('par3').set('npix', '300');
model.param('par3').descr('npix', 'Number of image pixels');
...
model.geom('geom1').feature('pi8').setEntry('inputexpr', 'w0', 'h_image');
model.geom('geom1').feature('pi8').setEntry('inputexpr', 'h0', 'h_image');
model.geom('geom1').feature('pi8').setEntry('inputexpr', 'w1', 0);
model.geom('geom1').feature('pi8').setEntry('inputexpr', 'h1', 0);
model.geom('geom1').feature('pi8').set('workplanesrc', 'pi1');
model.geom('geom1').feature('pi8').set('workplane', 'wp1');
model.geom('geom1').feature('pi8').set('displ', {'0' '0' 'Z_focus'});
model.geom('geom1').run('pi8');
model.geom('geom1').create('pi9', 'PartInstance');
model.geom('geom1').feature('pi9').set('selkeepnoncontr', false);
model.geom('geom1').feature('pi9').set('part', 'part3');
model.geom('geom1').feature('pi9').label('Object');
model.geom('geom1').feature('pi9').setEntry('inputexpr', 'w0', 'h_object');
model.geom('geom1').feature('pi9').setEntry('inputexpr', 'h0', 'h_object');
model.geom('geom1').feature('pi9').setEntry('inputexpr', 'w1', 0);
model.geom('geom1').feature('pi9').setEntry('inputexpr', 'h1', 0);
model.geom('geom1').feature('pi9').set('workplanesrc', 'pi1');
model.geom('geom1').feature('pi9').set('workplane', 'wp1');
model.geom('geom1').feature('pi9').set('displ', {'0' '0' '-1[m]'});
model.geom('geom1').selection.create('csel9', 'CumulativeSelection');
model.geom('geom1').selection('csel9').label('Object Plane');
model.geom('geom1').feature('pi9').setEntry('selcontributetobnd', 'pi9_sel1', 'csel9');
model.geom('geom1').runPre('fin');
model.geom('geom1').run;

model.mesh('mesh1').create('size1', 'Size');
model.mesh('mesh1').feature('size1').selection.geom('geom1', 2);
model.mesh('mesh1').feature('size1').selection.named('geom1_csel5_bnd');
model.mesh('mesh1').feature('size1').set('custom', true);
model.mesh('mesh1').feature('size1').set('hmaxactive', true);
model.mesh('mesh1').feature('size1').set('hmax', '1.0');
model.mesh('mesh1').feature('size').set('hauto', 2);
model.mesh('mesh1').create('map1', 'Map');
model.mesh('mesh1').feature('map1').selection.named('geom1_csel9_bnd');
model.mesh('mesh1').feature('map1').create('dis1', 'Distribution');
model.mesh('mesh1').feature('map1').feature('dis1').selection.set([1 2 3 160]);
model.mesh('mesh1').feature('map1').feature('dis1').set('numelem', '2*npix');
model.mesh('mesh1').create('map2', 'Map');
model.mesh('mesh1').feature('map2').selection.named('geom1_csel8_bnd');
model.mesh('mesh1').feature('map2').create('dis1', 'Distribution');
model.mesh('mesh1').feature('map2').feature('dis1').selection.set([54 55 56 150]);
model.mesh('mesh1').feature('map2').feature('dis1').set('numelem', 'npix');
model.mesh('mesh1').create('ftet1', 'FreeTet');
model.mesh('mesh1').run;

model.func.create('im1', 'Image');
model.func('im1').model('comp1');
model.func('im1').set('filename', 'double_gauss_lens_image_simulation_example.png');
model.func('im1').set('xmin', '-h_object/2');
model.func('im1').set('xmax', 'h_object/2');
model.func('im1').set('ymin', '-h_object/2');
model.func('im1').set('ymax', 'h_object/2');
model.func('im1').importData;

model.physics('gop').create('relb1', 'ReleaseFromBoundary', 2);
model.physics('gop').feature('relb1').selection.named('geom1_csel9_bnd');
model.physics('gop').feature('relb1').set('InitialPosition', 'Density');
model.physics('gop').feature('relb1').setIndex('Nr', 'Nrays', 0);
model.physics('gop').feature('relb1').set('dpro', 'comp1.im1(x,y)');
model.physics('gop').feature('relb1').set('RayDirectionVector', 'Conical');
model.physics('gop').feature('relb1').setIndex('Nw', 1, 0);
model.physics('gop').feature('relb1').set('cax', {'x/z' 'y/z' '1'});
model.physics('gop').feature('relb1').set('alphac', '0.70*atan(0.5*d1_clear_1/abs(z))');
model.physics('gop').feature('relb1').set('SamplingFromDistribution', 'Random');
model.physics('gop').feature('wall3').create('bacc1', 'BoundaryAccumulator', 2);
model.physics('gop').feature('wall3').feature('bacc1').set('AccumulatorType', 'Count');
model.physics('gop').feature('wall3').feature('bacc1').set('AccumulateOver', 'RaysInBoundaryElements');
model.physics('gop').feature('wall3').feature('bacc1').set('AccumulatedVariableName', 'Inum');
model.physics('gop').feature('wall3').feature('bacc1').set('R', 1);

model.study('std1').feature('rtrac').set('disabledphysics', {'gop/relg1' 'gop/wall3' 'gop/relb1'});
...
model.study('std2').feature('rtrac').set('disabledphysics', {'gop/relg1' 'gop/relg2'});
...
model.result('pg5').label('Ray Diagram 3');
...
model.result('pg5').feature('surf1').feature('sel1').selection.named('geom1_csel4_bnd');
model.result('pg5').create('surf2', 'Surface');
model.result('pg5').feature('surf2').label('Object');
...
model.result('pg5').feature('surf3').label('Image');
...
model.result('pg6').label('Object and Image');
model.result('pg6').set('edges', false);
model.result('pg6').create('surf1', 'Surface');
model.result('pg6').feature('surf1').label('Object');
...
model.title('Double Gauss Lens Image Simulation');

model.description('This example demonstrates how to import a bitmap which can be used as the object in a finite conjugate ray trace. The model is based on the Double Gauss Lens tutorial from the Ray Optics Module Application Library.');
