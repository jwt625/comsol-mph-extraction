function out = model
%
% bracket_fatigue_optimization.m
%
...
model.result.evaluationGroup('eg1').label('Initial Compliance');
model.result.evaluationGroup('eg1').setIndex('looplevelinput', 'last', 0);
model.result.evaluationGroup('eg1').create('gev1', 'EvalGlobal');
model.result.evaluationGroup('eg1').feature('gev1').set('expr', {'solid.Ws_tot'});
model.result.evaluationGroup('eg1').feature('gev1').set('descr', {'Total elastic strain energy'});
model.result.evaluationGroup('eg1').run;

model.param.set('pExp', '50');
model.param.descr('pExp', 'P-norm exponent');
model.param.set('sigmaMax', '100[MPa]');
model.param.descr('sigmaMax', 'Maximum stress');
model.param.set('Ws0', '0.69[J]');
model.param.descr('Ws0', 'Characteristic stiffness');

model.selection.create('sel7', 'Explicit');
model.selection('sel7').model('comp1');
model.selection('sel7').label('Free Boundaries');
model.selection('sel7').geom(2);
model.selection('sel7').set([24 25 28 29]);
model.selection.duplicate('sel8', 'sel7');
model.selection('sel8').label('Symmetry Boundaries');
model.selection('sel8').set([15 65]);
model.selection.create('adj2', 'Adjacent');
model.selection('adj2').model('comp1');
model.selection('adj2').label('Free Domains');
model.selection('adj2').set('entitydim', 2);
model.selection('adj2').set('outputdim', 3);
model.selection('adj2').set('input', {'sel7'});
model.selection.create('sel9', 'Explicit');
model.selection('sel9').model('comp1');
model.selection('sel9').label('Symmetry Domains');
model.selection('sel9').set([8]);

model.cpl.create('aveop1', 'Average', 'geom1');
model.cpl('aveop1').set('axisym', true);
model.cpl('aveop1').selection.named('adj2');

model.variable.create('var1');
model.variable('var1').model('comp1');
model.variable('var1').label('Objective Function');
model.variable('var1').set('obj', 'aveop1((solid.mises/sigmaMax)^pExp)^(1/pExp)');
...
model.common('fsd1').selection.named('adj2');
model.common.create('fsb1', 'FreeShapeBoundary', 'comp1');
model.common('fsb1').selection.named('sel7');
model.common('fsb1').set('maximumDisplacement', '3[mm]');
model.common.create('fsr1', 'FreeShapeSymmetry', 'comp1');
model.common('fsr1').selection.named('sel8');
model.common.create('mss1', 'MirrorShape', 'comp1');
model.common('mss1').selection.named('sel9');
...
model.study('std3').label('Optimized Design');
model.study('std3').feature.copy('stat1', 'std1/stat');
model.study('std3').create('sho', 'ShapeOptimization');
model.study('std3').feature('sho').set('mmamaxiter', 15);
model.study('std3').feature('sho').set('movelimit', 0.2);
model.study('std3').feature('sho').set('optobj', {'comp1.obj'});
model.study('std3').feature('sho').set('descr', {'Objective function'});
model.study('std3').feature('sho').setIndex('optobj', 'if(para==1, comp1.obj, 0)', 0);
model.study('std3').feature('sho').setIndex('descr', 'Objective Function', 0);
model.study('std3').feature('sho').set('objectivescaling', 'init');
model.study('std3').feature('sho').set('constraintExpression', {'comp1.fsd1.relVolume' 'comp1.solid.Ws_tot'});
model.study('std3').feature('sho').setIndex('constraintUbound', 1, 0);
model.study('std3').feature('sho').setIndex('constraintLbound', '', 0);
model.study('std3').feature('sho').setIndex('constraintExpression', 'comp1.solid.Ws_tot/Ws0', 1);
model.study('std3').feature('sho').setIndex('constraintLbound', '', 1);
model.study('std3').feature('sho').setIndex('constraintUbound', '', 1);
model.study('std3').feature('sho').setIndex('constraintUbound', 1, 1);
...
model.sol('sol3').feature('v1').feature('comp1_fsb1_d').set('scalemethod', 'manual');
model.sol('sol3').feature('v1').feature('comp1_material_disp').set('scalemethod', 'manual');
model.sol('sol3').feature('v1').feature('comp1_fsb1_d').set('scaleval', '3[mm]');
model.sol('sol3').feature('v1').feature('comp1_material_disp').set('scaleval', '0.0012424213651166173');
model.sol('sol3').feature('v1').set('control', 'stat1');
model.sol('sol3').create('o1', 'Optimization');
model.sol('sol3').feature('o1').set('control', 'sho');
model.sol('sol3').feature('o1').create('s1', 'StationaryAttrib');
model.sol('sol3').feature('o1').feature('s1').set('control', 'stat1');
model.sol('sol3').feature('o1').feature('s1').create('p1', 'Parametric');
model.sol('sol3').feature('o1').feature('s1').feature.remove('pDef');
model.sol('sol3').feature('o1').feature('s1').feature('p1').set('pname', {'para'});
model.sol('sol3').feature('o1').feature('s1').feature('p1').set('plistarr', {'0 1'});
model.sol('sol3').feature('o1').feature('s1').feature('p1').set('punit', {''});
model.sol('sol3').feature('o1').feature('s1').feature('p1').set('sweeptype', 'sparse');
model.sol('sol3').feature('o1').feature('s1').feature('p1').set('plot', 'off');
model.sol('sol3').feature('o1').feature('s1').feature('p1').set('probesel', 'none');
model.sol('sol3').feature('o1').feature('s1').feature('p1').set('control', 'stat1');
model.sol('sol3').feature('o1').feature('s1').set('control', 'stat1');
...
model.sol('sol3').feature('o1').feature('s1').feature('se1').feature('ss1').set('segvar', {'comp1_fsb1_c' 'comp1_material_disp' 'comp1_fsb1_d'});
...
model.sol('sol3').feature('o1').feature('s1').feature('se1').feature('ss2').set('segvar', {'comp1_u' 'comp1_fsb1_c'});
...
model.sol('sol3').feature('o1').feature('s1').feature('d1').set('pivotperturb', 1.0E-9);
model.sol('sol3').feature('o1').feature('s1').feature('d1').label('Suggested Direct Solver (solid)');
model.sol('sol3').feature('o1').feature('s1').feature('se1').feature('ss2').set('linsolver', 'd1');
model.sol('sol3').feature('o1').feature('s1').feature('se1').feature('ss2').label('Solid Mechanics');
...
model.sol('sol3').feature('o1').feature('s1').feature('i2').set('rhob', 400);
model.sol('sol3').feature('o1').feature('s1').feature('i2').set('nlinnormuse', true);
model.sol('sol3').feature('o1').feature('s1').feature('i2').label('Suggested Iterative Solver (solid)');
...
model.sol('sol3').feature('o1').feature('s1').feature('i2').feature('mg1').feature('pr').feature('so1').set('relax', 0.8);
model.sol('sol3').feature('o1').feature('s1').feature('i2').feature('mg1').feature('po').create('so1', 'SOR');
model.sol('sol3').feature('o1').feature('s1').feature('i2').feature('mg1').feature('po').feature('so1').set('relax', 0.8);
...
model.sol('sol3').feature('o1').feature('s1').feature('i2').feature('mg1').feature('cs').feature('d1').set('pivotperturb', 1.0E-9);
...
model.result.dataset.duplicate('dset3g1', 'dset3');
model.result.dataset('dset3g1').label('Optimized Design/Solution 3 (3) - Geometry');
model.result.dataset('dset3g1').set('frametype', 'geometry');
...
model.result('pg4').create('con1', 'Surface');
model.result('pg4').feature('con1').set('expr', 'fsd1.rel_disp');
model.result('pg4').feature('con1').set('colortabletype', 'discrete');
model.result('pg4').feature('con1').set('bandcount', 20);
model.result('pg4').feature('con1').set('rangecoloractive', true);
model.result('pg4').feature('con1').set('rangecolormin', 0);
model.result('pg4').feature('con1').set('rangecolormax', 1);
model.result('pg4').feature('con1').set('colortable', 'RainbowLight');
model.result('pg4').feature('con1').set('smooth', 'none');
model.result('pg4').create('arws1', 'ArrowSurface');
model.result('pg4').feature('arws1').set('data', 'dset3g1');
model.result('pg4').feature('arws1').set('expr', {'fsd1.dXg' 'fsd1.dYg' 'fsd1.dZg'});
model.result('pg4').feature('arws1').set('scaleactive', true);
model.result('pg4').feature('arws1').set('scale', '1');
model.result('pg4').feature('arws1').set('placement', 'uniform');
model.result('pg4').feature('arws1').set('arrowcount', 200);
model.result('pg4').feature('arws1').create('sel1', 'Selection');
model.result('pg4').feature('arws1').feature('sel1').selection.named('dsel_fsd1');
model.result('pg3').run;
model.result.remove('pg3');
model.result('pg4').run;

model.sol('sol3').feature('o1').set('gcmma', false);
model.sol('sol3').feature('o1').feature('s1').feature('se1').feature('ss2').set('linsolver', 'i2');

model.study('std3').feature('sho').set('plot', true);
model.study('std3').feature('sho').set('plotgroup', 'pg4');
...
model.study('std2').label('Initial Fatigue');
model.study('std4').label('Optimized Fatigue');
model.study('std4').feature.copy('param1', 'std2/param');
model.study('std4').feature.copy('ftge1', 'std2/ftge');
model.study('std4').feature('ftge1').set('notstudy', 'std3');
...
model.sol('sol4').feature('st1').set('studystep', 'ftge1');
model.sol('sol4').create('v1', 'Variables');
model.sol('sol4').feature('v1').feature('comp1_material_disp').set('scalemethod', 'manual');
model.sol('sol4').feature('v1').feature('comp1_material_disp').set('scaleval', '0.0012424213651166173');
model.sol('sol4').feature('v1').set('control', 'ftge1');
model.sol('sol4').create('s1', 'Stationary');
model.sol('sol4').feature('s1').create('p1', 'Parametric');
model.sol('sol4').feature('s1').feature('p1').set('pname', {'k'});
model.sol('sol4').feature('s1').feature('p1').set('plistarr', {'0.7 0.28'});
model.sol('sol4').feature('s1').feature('p1').set('punit', {''});
...
model.sol('sol4').feature('s1').feature('p1').set('control', 'param1');
model.sol('sol4').feature('s1').set('control', 'ftge1');
...
model.result('pg5').label('Cycles to Failure (ftg) 1');
...
model.result.dataset('dset4g1').label('Optimized Fatigue/Solution 4 (4) - Geometry');
model.result.dataset('dset4g1').set('frametype', 'geometry');
model.result('pg6').label('Shape Optimization 1');
...
model.result('pg6').feature('arws1').set('data', 'dset4g1');
...
model.result('pg5').run;
model.result('pg5').label('Cycles to Failure, Optimized');
model.result('pg5').set('data', 'dset3');
model.result('pg5').run;
model.result('pg5').feature('surf1').set('expr', 'withsol(''sol4'',ftg.ctf)');
model.result.evaluationGroup.create('eg2', 'EvaluationGroup');
model.result.evaluationGroup('eg2').label('Fatigue Comparison');
model.result.evaluationGroup('eg2').set('data', 'dset2');
model.result.evaluationGroup('eg2').create('min1', 'MinSurface');
model.result.evaluationGroup('eg2').feature('min1').selection.named('sel7');
model.result.evaluationGroup('eg2').feature('min1').set('expr', {'ftg.ctf'});
model.result.evaluationGroup('eg2').feature('min1').set('descr', {'Cycles to failure'});
model.result.evaluationGroup('eg2').feature.duplicate('min2', 'min1');
model.result.evaluationGroup('eg2').feature('min2').set('data', 'dset4');
model.result.evaluationGroup('eg2').run;
model.result.create('pg6', 'PlotGroup3D');
model.result('pg6').run;
model.result('pg6').label('Shape Optimization, Volumetric');
...
model.result('pg6').run;
model.result('pg6').feature('vol2').set('data', 'dset1');
model.result('pg6').feature('vol2').set('color', 'gray');
model.result('pg6').feature('vol2').create('def1', 'Deform');
model.result('pg6').run;
model.result('pg6').feature('vol2').feature('def1').label('Deformation 1 - Z-fighting perturbation fix');
model.result('pg6').feature('vol2').feature('def1').set('expr', {'-(Xg+0.0975)*5e-4' 'v' 'w'});
model.result('pg6').feature('vol2').feature('def1').setIndex('expr', '-(Yg-0.1)*5e-4', 1);
model.result('pg6').feature('vol2').feature('def1').setIndex('expr', '-(Zg-0.046)*5e-4', 2);
model.result('pg6').feature('vol2').feature('def1').set('scaleactive', true);
model.result('pg6').run;
model.result('pg6').create('line1', 'Line');
...
model.title(['Bracket ' native2unicode(hex2dec({'20' '14'}), 'unicode') ' Stress Optimization with Fatigue Evaluation']);

model.description(['Shape optimization with respect to fatigue properties is not supported, but fatigue properties are well correlated with the maximum stress. The model demonstrates how optimization with respect to a p-norm of the von' native2unicode(hex2dec({'00' 'a0'}), 'unicode') 'Mises stress can be used to improve fatigue properties without increasing mass or decreasing stiffness.']);
...
model.label('bracket_fatigue_optimization.mph');
