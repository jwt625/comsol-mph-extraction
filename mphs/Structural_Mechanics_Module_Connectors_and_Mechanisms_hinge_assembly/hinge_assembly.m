...
model.modelPath('/Applications/COMSOL62/Multiphysics/applications/Structural_Mechanics_Module/Connectors_and_Mechanisms');
...
model.physics('solid').feature('fix1').selection.set([133 134 135 136]);
model.physics('solid').create('rig1', 'RigidConnector', 2);
model.physics('solid').feature('rig1').selection.set([67 68]);
model.physics('solid').feature('rig1').setIndex('Direction', true, 0);
model.physics('solid').feature('rig1').create('rf1', 'RigidBodyForce', -1);
model.physics('solid').feature('rig1').feature('rf1').set('Include_offset', true);
model.physics('solid').feature('rig1').feature('rf1').set('x_off', [0 -0.1 0]);
model.physics('solid').feature('rig1').feature('rf1').set('Ft', {'0' '0' 'F'});
model.physics('solid').create('rig2', 'RigidConnector', 2);
model.physics('solid').feature('rig2').selection.set([75 76]);
model.physics('solid').create('rig3', 'RigidConnector', 2);
model.physics('solid').feature('rig3').selection.set([16 17 18 19]);
model.physics('solid').feature('rig3').setIndex('Direction', true, 0);
model.physics('solid').feature('rig3').setIndex('U0', 'solid.rig2.u', 0);
model.physics('solid').feature('rig3').setIndex('Direction', true, 1);
model.physics('solid').feature('rig3').setIndex('U0', 'solid.rig2.v', 1);
model.physics('solid').feature('rig3').setIndex('Direction', true, 2);
model.physics('solid').feature('rig3').setIndex('U0', 'solid.rig2.w', 2);
model.physics('solid').create('gconstr1', 'GlobalConstraint', -1);
model.physics('solid').feature('gconstr1').set('constraintExpression', 'comp1.solid.rig2.b-comp1.solid.rig3.b');
model.physics('solid').create('gconstr2', 'GlobalConstraint', -1);
model.physics('solid').feature('gconstr2').set('constraintExpression', 'comp1.solid.rig2.d-comp1.solid.rig3.d');
...
model.sol('sol1').feature('v1').feature('comp1_solid_rig_disp').set('scaleval', '0.0054020058194673886');
...
model.result('pg2').feature('vol1').set('descr', 'Displacement field, X-component');
model.result('pg2').run;
model.result('pg2').run;
model.result('pg2').label('x-Displacement');

model.title('Assembly with a Hinge');

model.description('A hinge between two mechanical components is modeled by coupling two rigid connectors. This method can be used for simulating many types of mechanisms.');

model.mesh.clearMeshes;

model.sol('sol1').clearSolutionData;

model.label('hinge_assembly.mph');
