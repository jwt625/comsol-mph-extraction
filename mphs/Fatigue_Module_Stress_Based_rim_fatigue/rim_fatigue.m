...
model.result('pg1').feature('vol1').set('rangecolormin', 0);
...
model.result('pg3').feature('vol1').set('expr', {'solid2.mises'});
...
model.physics('ftg').feature('stre1').selection.set([2 3 4 5]);
model.physics('ftg').feature('stre1').set('fatigueInputPhysics', 'solid2');

model.material.create('mat3', 'Common', 'comp2');
model.material('mat3').selection.geom('geom2', 2);
model.material('mat3').selection.all;
model.material('mat3').propertyGroup.create('fatigueStressFindley', 'Findley[Fatigue]');
model.material('mat3').propertyGroup('fatigueStressFindley').set('k_Findley', {'0.30'});
model.material('mat3').propertyGroup('fatigueStressFindley').set('f_Findley', {'84[MPa]'});
...
model.result('pg4').feature('surf1').set('expr', {'ftg.fus'});
...
model.result('pg4').label('Fatigue Usage Factor (ftg)');
...
model.result.dataset('cpt1').set('pointx', 0.0164);
model.result.dataset('cpt1').set('pointy', 0.0924);
model.result.dataset('cpt1').set('pointz', 0.0884);
...
model.result('pg5').run;
model.result('pg5').label('Stress History');
model.result('pg5').set('titletype', 'manual');
model.result('pg5').set('title', 'Stress history at the critical point');
model.result('pg5').run;
model.result('pg4').run;

model.title('Fatigue Analysis of a Wheel Rim');

model.description('High Cycle Fatigue (HCF) of a spoke in a wheel rim is studied. As the wheel rotates, the stress histories in the structure will become nonproportional. The risk of fatigue is evaluated using the Findley criterion.');
