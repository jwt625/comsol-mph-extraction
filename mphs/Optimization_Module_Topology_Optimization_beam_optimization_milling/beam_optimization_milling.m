...
model.sol('sol4').feature('o1').feature('s1').set('solveforvars', {});
...
model.sol('sol5').feature('o1').feature('s1').set('solveforvars', {});
...
model.common.remove('poly1');
model.common.remove('fsr1');

model.param.set('volfrac', '0.4');
model.param.descr('volfrac', 'Volume fraction');
model.param.set('meshsz', '1[cm]');
model.param.descr('meshsz', 'Mesh size');

model.common('dtopo1').set('millingActive', 'Enabled');
model.common('dtopo1').setIndex('mil_xVector', 0, 1);
model.common('dtopo1').setIndex('mil_yVector', 0, 1);
model.common('dtopo1').setIndex('mil_xVector', 0, 1);
model.common('dtopo1').setIndex('mil_yVector', 0, 1);
model.common('dtopo1').setIndex('mil_xVector', 0, 0);
model.common('dtopo1').setIndex('mil_yVector', 1, 0);
model.common('dtopo1').setIndex('mil_xVector', 1, 1);
model.common('dtopo1').setIndex('mil_yVector', 0, 1);
model.common('dtopo1').set('filterLengthType', 'Custom');
model.common('dtopo1').set('projectionType', 'TanhProjection');
model.common('dtopo1').set('theta_0', '0.1');
...
model.sol('sol5').feature('o1').feature('s1').feature('se1').feature('ss2').label('Solid Mechanics');
model.sol('sol5').feature('o1').feature('s1').feature('se1').feature('ss2').set('segvar', {'comp1_dtopo1_theta_c' 'comp1_u'});
model.sol('sol5').feature('o1').feature('s1').feature('se1').feature('ss1').label('Milling');
model.sol('sol5').feature('o1').feature('s1').feature('se1').feature('ss1').set('segvar', {'comp1_dtopo1_theta_c' 'comp1_dtopo1_theta_m1' 'comp1_dtopo1_theta_m2'});
model.sol('sol5').feature('o1').feature('s1').feature('se1').feature('ssDef').label('Optimization');
model.sol('sol5').feature('o1').feature('s1').feature('se1').feature('ssDef').set('segvar', {'comp1_dtopo1_theta_c' 'comp1_dtopo1_theta_f'});

model.result('pg3').run;
model.result('pg3').set('title', 'Topology Optimization (milling) - eval(mass1.mass) kg');
...
model.title('Topology Optimization of a Beam with Milling Constraints');

model.description('The mass of an aluminum beam is minimized subject to a displacement constraint and a distributed load. The problem is solved using topology optimization with milling constraints.');
