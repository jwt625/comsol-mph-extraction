...
model.param.descr('w_BJT', 'BJT width');
model.param.set('d_BJT', '1[um]');
model.param.descr('d_BJT', 'BJT thickness');
model.param.set('l_BJT', '3[um]');
model.param.descr('l_BJT', 'BJT length');
model.param.set('w_E', '1.2[um]');
model.param.descr('w_E', 'Emitter width');
model.param.set('l_E', '3[um]');
model.param.descr('l_E', 'Emitter length');
model.param.set('w_EB', '0.35[um]');
model.param.descr('w_EB', 'Emitter-base spacing');
model.param.set('w_cE', 'w_E/2-d_E');
model.param.descr('w_cE', 'Emitter contact width');
model.param.set('w_cB', 'w_BJT/2-w_EB-w_E/2');
model.param.descr('w_cB', 'Base contact width');
model.param.set('l_cB', '3[um]');
model.param.descr('l_cB', 'Base contact length');
model.param.set('w_cC', 'w_BJT');
model.param.descr('w_cC', 'Collector contact width');
model.param.set('d_E', '0.15[um]');
model.param.descr('d_E', 'Emitter junction depth');
model.param.set('d_B', '0.3[um]');
model.param.descr('d_B', 'Base junction depth');
model.param.set('d_C', '0.3[um]');
model.param.descr('d_C', 'Collector junction depth');
model.param.set('N_epi', '2e16[1/cm^3]');
model.param.descr('N_epi', 'Epitaxial layer doping');
model.param.set('N_B', '9e17[1/cm^3]');
model.param.descr('N_B', 'Base doping');
model.param.set('N_E', '2e20[1/cm^3]');
model.param.descr('N_E', 'Emitter doping');
model.param.set('N_C', '8e19[1/cm^3]');
model.param.descr('N_C', 'Collector doping');
model.param.set('V_C', '0.5[V]');
model.param.descr('V_C', 'Applied voltage: collector');
model.param.set('V_B', '0.5[V]');
model.param.descr('V_B', 'Applied voltage: base');
model.param.set('V_E', '0[V]');
model.param.descr('V_E', 'Applied voltage: emitter');
model.param.set('I_B', '-1[uA]');
model.param.descr('I_B', 'Inward applied current: base');
model.param.set('I_C', '0[uA]');
model.param.descr('I_C', 'Inward applied current: collector');

model.geom('geom1').lengthUnit([native2unicode(hex2dec({'00' 'b5'}), 'unicode') 'm']);
model.geom('geom1').create('blk1', 'Block');
model.geom('geom1').feature('blk1').set('size', {'w_BJT/2' 'l_BJT/2' '1'});
model.geom('geom1').feature('blk1').setIndex('size', 'd_BJT', 2);
model.geom('geom1').run('blk1');
model.geom('geom1').create('blk2', 'Block');
model.geom('geom1').feature('blk2').set('size', {'w_BJT/2' 'l_BJT/2' '1'});
model.geom('geom1').feature('blk2').setIndex('size', '1*d_E', 2);
model.geom('geom1').feature('blk2').set('pos', {'0' '0' 'd_BJT-1.25*d_E'});
model.geom('geom1').run('blk2');
model.geom('geom1').create('wp1', 'WorkPlane');
model.geom('geom1').feature('wp1').set('unite', true);
model.geom('geom1').feature('wp1').set('quickz', 'd_BJT');
model.geom('geom1').feature('wp1').geom.create('r1', 'Rectangle');
model.geom('geom1').feature('wp1').geom.feature('r1').set('size', {'w_cE' 'l_E/2-2*d_E'});
model.geom('geom1').feature('wp1').geom.run('r1');
model.geom('geom1').feature('wp1').geom.create('r2', 'Rectangle');
model.geom('geom1').feature('wp1').geom.feature('r2').set('size', {'w_BJT/2-w_EB-w_E/2' '1'});
model.geom('geom1').feature('wp1').geom.feature('r2').setIndex('size', 'l_cB/2-2*d_E', 1);
model.geom('geom1').feature('wp1').geom.feature('r2').set('pos', {'w_BJT/2-w_cB' '0'});
...
model.physics('semi').feature('adm1').label('Constant Background n Doping');
model.physics('semi').create('adm2', 'AnalyticDopingModel', 3);
...
model.physics('semi').feature('adm2').set('rb', {'0[um]' '0[um]' 'd_BJT-d_E'});
model.physics('semi').feature('adm2').set('jwidth', 'w_BJT/2');
model.physics('semi').feature('adm2').set('jdepth', 'l_cB/2');
model.physics('semi').feature('adm2').set('jheight', 'd_E');
model.physics('semi').feature('adm2').set('jds', 'd_E');
model.physics('semi').feature('adm2').set('Nb_src', 'root.comp1.semi.adm1.NDc');
model.physics('semi').feature('adm2').label('Base p Doping');
model.physics('semi').create('adm3', 'AnalyticDopingModel', 3);
...
model.physics('semi').feature('adm3').set('rb', {'0[um]' '0[um]' 'd_BJT'});
model.physics('semi').feature('adm3').set('jwidth', 'w_E/2-d_E');
model.physics('semi').feature('adm3').set('jdepth', 'l_E/2-2*d_E');
model.physics('semi').feature('adm3').set('jds', 'd_E');
model.physics('semi').feature('adm3').set('Nb', 'N_B');
model.physics('semi').feature('adm3').label('Emitter n Doping');
model.physics('semi').create('adm4', 'AnalyticDopingModel', 3);
...
model.physics('semi').feature('adm4').set('jdepth', 'l_BJT/2');
model.physics('semi').feature('adm4').set('jds', '1.3*d_C');
model.physics('semi').feature('adm4').set('Nb_src', 'root.comp1.semi.adm1.NDc');
model.physics('semi').feature('adm4').label('Collector n Doping');
model.physics('semi').create('tar1', 'TrapAssistedRecombination', 3);
model.physics('semi').feature('tar1').selection.all;
model.physics('semi').create('mc1', 'MetalContact', 2);
model.physics('semi').feature('mc1').selection.set([10]);
...
model.physics('semi').feature('mc2').selection.set([15]);
...
model.physics('semi').feature('mc3').selection.set([3]);
...
model.mesh('mesh1').feature('bl1').feature('blp').selection.set([3 10 11 15]);
model.mesh('mesh1').feature('bl1').feature('blp').set('blstretch', 1.5);
model.mesh('mesh1').feature('bl1').feature('blp').set('inittype', 'blhmin');
model.mesh('mesh1').feature('bl1').feature('blp').set('blhmin', '1e-4');
...
model.sol('sol3').feature('v1').feature('comp1_Ph_lm').set('scaleval', '1.0E12');
model.sol('sol3').feature('v1').feature('comp1_Ne_lm').set('scaleval', '1.0E12');
...
model.sol('sol3').feature('v1').feature('comp1_V_lm').set('scaleval', '1.0E12');
...
model.sol('sol4').feature('v1').feature('comp1_Ph_lm').set('scaleval', '1.0E12');
model.sol('sol4').feature('v1').feature('comp1_Ne_lm').set('scaleval', '1.0E12');
...
model.sol('sol4').feature('v1').feature('comp1_V_lm').set('scaleval', '1.0E12');
...
model.result('pg5').feature('arwv1').set('expr', {'semi.JnX' 'semi.JnY' ''});
...
model.title('3D Analysis of a Bipolar Transistor');

model.description('This example shows how to set up an analysis of a bipolar transistor in 3D. This model demonstrates that 3D semiconductor models can be efficiently solved by finite element logarithmic formulations.');
