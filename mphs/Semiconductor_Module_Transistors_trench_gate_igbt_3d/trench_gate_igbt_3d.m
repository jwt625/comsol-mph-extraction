...
model.geom('geom2').feature('wp1').geom.insertFile('trench_gate_igbt_2d.mph', 'geom1');
model.geom('geom2').feature('wp1').geom.feature('pt1').label('Point 1 - Emitter contact');
model.geom('geom2').feature('wp1').geom.feature('pt1').setIndex('p', 'Wewin/2', 0);
model.geom('geom2').feature('wp1').geom.feature('pt1').setIndex('p', 0, 1);
model.geom('geom2').run('wp1');
model.geom('geom2').feature.create('ext1', 'Extrude');
model.geom('geom2').feature('ext1').setIndex('distance', '-Ln/2', 0);
model.geom('geom2').feature('ext1').setIndex('distance', '-Ln/2-Lp/2', 1);
model.geom('geom2').feature('ext1').set('displ', {'0' '0'; '0' '0'});
model.geom('geom2').feature('ext1').set('scale', {'1' '1'; '1' '1'});
model.geom('geom2').feature('ext1').set('twist', {'0' '0'});
model.geom('geom2').run('fin');
model.geom('geom2').create('mcf1', 'MeshControlFaces');

model.view('view2').set('renderwireframe', true);

model.geom('geom2').feature('mcf1').selection('input').set('fin', [12 15 28 31 40 42 43 45 47 49 51 52 54 56 67 69 73 77 80 82]);
model.geom('geom2').run('mcf1');
...
model.physics.copy('semi2', 'semi', 'comp2');
model.physics('semi2').feature('smm1').set('mun_mat', 'root.comp2.semi2.mun_ct');
model.physics('semi2').feature('smm1').set('mup_mat', 'root.comp2.semi2.mup_ct');
model.physics('semi2').feature('smm1').feature('mmct1').set('mun_in_src', 'root.comp2.semi2.mun_kl');
model.physics('semi2').feature('smm1').feature('mmct1').set('mup_in_src', 'root.comp2.semi2.mup_kl');
model.physics('semi2').feature('adm1').selection.set([3 6]);
model.physics('semi2').feature('adm2').selection.set([2 5]);
model.physics('semi2').feature('adm3').selection.set([1 4]);
model.physics('semi2').feature('gdm1').selection.set([3 6]);
model.physics('semi2').feature('gdm1').feature('gdmbs1').selection.set([10 20 24 25 30 31]);
model.physics('semi2').feature('gdm2').selection.set([3 6]);
model.physics('semi2').feature('gdm2').feature('gdmbs1').selection.set([20 25]);
model.physics('semi2').feature('gdm3').selection.set([3 6]);
model.physics('semi2').feature('gdm3').feature('gdmbs1').selection.set([10 24]);
model.physics('semi2').feature('tar1').selection.all;
model.physics('semi2').feature('mc1').selection.set([10 20]);
model.physics('semi2').feature('mc1').set('TerminalName', 'E');
model.physics('semi2').feature('mc2').selection.set([3 13]);
model.physics('semi2').feature('mc2').set('TerminalName', 'C');
model.physics('semi2').feature('gc1').selection.set([26 27 28 29]);
model.physics('semi2').feature('gc1').set('TerminalName', 'G');

model.mesh('mesh2').create('edg1', 'Edge');
model.mesh('mesh2').feature('edg1').label('Edge 1 - Metal contact');

model.view('view2').set('showgrid', false);
model.view('view2').set('renderwireframe', false);

model.mesh('mesh2').feature('edg1').selection.set([11]);
model.mesh('mesh2').feature('edg1').set('smoothcontrol', false);
model.mesh('mesh2').feature('edg1').create('dis1', 'Distribution');
model.mesh('mesh2').feature('edg1').feature('dis1').set('type', 'predefined');
model.mesh('mesh2').feature('edg1').feature('dis1').set('elemcount', 2);
model.mesh('mesh2').feature('edg1').feature('dis1').set('elemratio', 3);
model.mesh('mesh2').feature('edg1').feature('dis1').set('reverse', true);
model.mesh('mesh2').feature('size').set('custom', true);
model.mesh('mesh2').feature('size').set('hmax', 9.1);
model.mesh('mesh2').feature('size').set('hmin', 0.04);
model.mesh('mesh2').feature('size').set('hgrad', 1.25);
model.mesh('mesh2').feature('size').set('hcurve', 0.35);
model.mesh('mesh2').feature('size').set('hnarrow', 1.1);
model.mesh('mesh2').create('edg2', 'Edge');
model.mesh('mesh2').feature('edg2').label('Edge 2 - Emitter surface');
model.mesh('mesh2').feature('edg2').selection.set([31]);
model.mesh('mesh2').feature('edg2').set('smoothcontrol', false);
model.mesh('mesh2').feature('edg2').create('dis1', 'Distribution');
model.mesh('mesh2').feature('edg2').feature('dis1').set('type', 'predefined');
model.mesh('mesh2').feature('edg2').feature('dis1').set('elemcount', 8);
model.mesh('mesh2').feature('edg2').feature('dis1').set('elemratio', 4);
model.mesh('mesh2').feature('edg2').feature('dis1').set('symmetric', true);
model.mesh('mesh2').create('cpe1', 'CopyEdge');
model.mesh('mesh2').feature('cpe1').selection('source').geom(1);
model.mesh('mesh2').feature('cpe1').selection('destination').geom(1);
model.mesh('mesh2').feature('cpe1').selection('source').set([11 31]);
model.mesh('mesh2').feature('cpe1').selection('destination').set([94]);
model.mesh('mesh2').feature('cpe1').set('smoothcontrol', false);
model.mesh('mesh2').create('map1', 'Map');
model.mesh('mesh2').feature('map1').label('Mapped 1 - Emitter depth');
model.mesh('mesh2').feature('map1').selection.set([45]);
model.mesh('mesh2').feature('map1').set('smoothcontrol', false);
model.mesh('mesh2').feature('map1').set('adjustedgdistr', true);
model.mesh('mesh2').feature('map1').create('dis1', 'Distribution');
model.mesh('mesh2').feature('map1').feature('dis1').selection.set([68 105]);
...
model.mesh('mesh2').create('cpe2', 'CopyEdge');
model.mesh('mesh2').feature('cpe2').selection('source').geom(1);
model.mesh('mesh2').feature('cpe2').selection('destination').geom(1);
model.mesh('mesh2').feature('cpe2').selection('source').set([105]);
model.mesh('mesh2').feature('cpe2').selection('destination').set([35]);
model.mesh('mesh2').feature('cpe2').set('smoothcontrol', false);
model.mesh('mesh2').create('map2', 'Map');
model.mesh('mesh2').feature('map2').label('Mapped 2 - Gate depth');
model.mesh('mesh2').feature('map2').selection.set([41 42 43 44]);
model.mesh('mesh2').feature('map2').set('smoothcontrol', false);
model.mesh('mesh2').feature('map2').set('adjustedgdistr', true);
model.mesh('mesh2').feature('map2').create('dis1', 'Distribution');
model.mesh('mesh2').feature('map2').feature('dis1').label('Distribution 1 - Left depth');
model.mesh('mesh2').feature('map2').feature('dis1').selection.set([73 103 107]);
model.mesh('mesh2').feature('map2').feature('dis1').set('type', 'predefined');
model.mesh('mesh2').feature('map2').feature('dis1').set('elemratio', 10);
model.mesh('mesh2').feature('map2').feature('dis1').set('reverse', true);
model.mesh('mesh2').feature('map2').create('dis2', 'Distribution');
model.mesh('mesh2').feature('map2').feature('dis2').label('Distribution 2 - Right depth');
model.mesh('mesh2').feature('map2').feature('dis2').selection.set([46 132]);
model.mesh('mesh2').feature('map2').feature('dis2').set('type', 'predefined');
model.mesh('mesh2').feature('map2').feature('dis2').set('elemratio', 10);
model.mesh('mesh2').feature('map2').create('dis3', 'Distribution');
model.mesh('mesh2').feature('map2').feature('dis3').label('Distribution 3 - Left surface');
model.mesh('mesh2').feature('map2').feature('dis3').selection.set([76 101]);
model.mesh('mesh2').feature('map2').feature('dis3').set('type', 'predefined');
model.mesh('mesh2').feature('map2').feature('dis3').set('elemcount', 20);
model.mesh('mesh2').feature('map2').feature('dis3').set('elemratio', 3);
model.mesh('mesh2').feature('map2').feature('dis3').set('symmetric', true);
model.mesh('mesh2').feature('map2').create('dis4', 'Distribution');
model.mesh('mesh2').feature('map2').feature('dis4').label('Distribution 4 - Right surface');
model.mesh('mesh2').feature('map2').feature('dis4').selection.set([82 136]);
model.mesh('mesh2').feature('map2').feature('dis4').set('type', 'predefined');
model.mesh('mesh2').feature('map2').feature('dis4').set('elemcount', 6);
model.mesh('mesh2').feature('map2').feature('dis4').set('elemratio', 4);
model.mesh('mesh2').feature('map2').create('dis5', 'Distribution');
model.mesh('mesh2').feature('map2').feature('dis5').label('Distribution 5 - Bottom surface');
model.mesh('mesh2').feature('map2').feature('dis5').selection.set([41 77 104 127]);
model.mesh('mesh2').feature('map2').feature('dis5').set('type', 'predefined');
model.mesh('mesh2').feature('map2').feature('dis5').set('elemcount', 8);
model.mesh('mesh2').run('map2');
model.mesh('mesh2').create('ftri1', 'FreeTri');
model.mesh('mesh2').feature('ftri1').selection.set([40]);
model.mesh('mesh2').feature('ftri1').set('smoothcontrol', false);
model.mesh('mesh2').run('ftri1');
model.mesh('mesh2').create('cpe3', 'CopyEdge');
model.mesh('mesh2').feature('cpe3').selection('source').set([92]);
model.mesh('mesh2').feature('cpe3').selection('destination').set([3 6 9]);
model.mesh('mesh2').feature('cpe3').set('smoothcontrol', false);
model.mesh('mesh2').create('map3', 'Map');
model.mesh('mesh2').feature('map3').selection.set([2 5 8]);
model.mesh('mesh2').feature('map3').set('smoothcontrol', false);
model.mesh('mesh2').feature('map3').set('adjustedgdistr', true);
model.mesh('mesh2').feature('map3').create('dis1', 'Distribution');
model.mesh('mesh2').feature('map3').feature('dis1').label('Distribution 1 - n-base');
model.mesh('mesh2').feature('map3').feature('dis1').selection.set([7 88]);
model.mesh('mesh2').feature('map3').feature('dis1').set('type', 'predefined');
model.mesh('mesh2').feature('map3').feature('dis1').set('elemcount', 10);
model.mesh('mesh2').feature('map3').feature('dis1').set('elemratio', 5);
model.mesh('mesh2').feature('map3').feature('dis1').set('symmetric', true);
model.mesh('mesh2').feature('map3').create('dis2', 'Distribution');
model.mesh('mesh2').feature('map3').feature('dis2').label('Distribution 2 - n-buffer');
model.mesh('mesh2').feature('map3').feature('dis2').selection.set([4 52]);
model.mesh('mesh2').feature('map3').feature('dis2').set('type', 'predefined');
model.mesh('mesh2').feature('map3').feature('dis2').set('elemratio', 10);
model.mesh('mesh2').feature('map3').create('dis3', 'Distribution');
model.mesh('mesh2').feature('map3').feature('dis3').label('Distribution 3 - p+ collector');
model.mesh('mesh2').feature('map3').feature('dis3').selection.set([1 50]);
model.mesh('mesh2').feature('map3').feature('dis3').set('type', 'predefined');
model.mesh('mesh2').feature('map3').feature('dis3').set('elemcount', 3);
model.mesh('mesh2').feature('map3').feature('dis3').set('elemratio', 30);
model.mesh('mesh2').feature('map3').feature('dis3').set('reverse', true);
model.mesh('mesh2').create('swe1', 'Sweep');
model.mesh('mesh2').feature('swe1').selection.geom('geom2', 3);
model.mesh('mesh2').feature('swe1').selection.set([1 2 3 7 8 9 10 11 12]);
...
model.mesh('mesh2').feature('swe1').feature('dis1').set('elemcount', 4);
model.mesh('mesh2').feature('swe1').feature('dis1').set('elemratio', 6);
model.mesh('mesh2').feature('swe1').feature('dis1').set('reverse', true);
model.mesh('mesh2').feature.duplicate('swe2', 'swe1');
model.mesh('mesh2').feature('swe2').selection.set([4 5 6 13 14 15 16 17 18]);
model.mesh('mesh2').feature('swe2').feature('dis1').set('reverse', false);
model.mesh('mesh2').run;

model.study('std1').label('Study 1 - 2D');
model.study('std1').feature('semie').set('useadvanceddisable', true);
model.study('std1').feature('semie').setSolveFor('/physics/semi2', false);
model.study('std1').feature('semie').set('disabledphysics', {'semi2'});
model.study('std1').feature('stat').set('useadvanceddisable', true);
model.study('std1').feature('stat').setSolveFor('/physics/semi2', false);
model.study('std1').feature('stat').set('disabledphysics', {'semi2'});
model.study.create('std2');
model.study('std2').label('Study 2 - 3D');
model.study('std2').feature.copy('semie1', 'std1/semie');
model.study('std2').feature.copy('stat1', 'std1/stat');
model.study('std2').feature('semie1').setSolveFor('/physics/semi', false);
model.study('std2').feature('semie1').set('disabledphysics', {'semi2' 'semi'});
model.study('std2').feature('semie1').setSolveFor('/physics/semi2', true);
model.study('std2').feature('stat1').setSolveFor('/physics/semi', false);
model.study('std2').feature('stat1').set('disabledphysics', {'semi2' 'semi'});
model.study('std2').feature('stat1').setSolveFor('/physics/semi2', true);

model.sol.create('sol3');
model.sol('sol3').study('std2');
model.sol('sol3').create('st1', 'StudyStep');
model.sol('sol3').feature('st1').set('study', 'std2');
model.sol('sol3').feature('st1').set('studystep', 'semie1');
model.sol('sol3').create('v1', 'Variables');
model.sol('sol3').feature('v1').set('control', 'semie1');
model.sol('sol3').create('s1', 'Stationary');
model.sol('sol3').feature('s1').set('stol', 1.0E-5);
...
model.sol('sol3').feature('s1').feature('se1').feature('ss1').set('segvar', {'comp2_V' 'comp2_Ne' 'comp2_Ph' 'comp2_semi2_V_dae'});
...
model.sol('sol3').feature('s1').feature('se1').feature('ss2').set('segvar', {'comp2_semi2_smm1_mmct1_Epn' 'comp2_semi2_smm1_mmct1_Epp'});
...
model.sol('sol3').feature('st2').set('studystep', 'stat1');
...
model.sol('sol3').feature('v2').set('control', 'stat1');
model.sol('sol3').create('s2', 'Stationary');
model.sol('sol3').feature('s2').set('stol', 1.0E-5);
...
model.sol('sol3').feature('s2').feature('p1').set('control', 'stat1');
model.sol('sol3').feature('s2').set('control', 'stat1');
...
model.sol('sol3').feature('s2').feature('se1').feature('ss1').set('segvar', {'comp2_V' 'comp2_Ne' 'comp2_Ph' 'comp2_semi2_n_bnd' 'comp2_semi2_p_bnd' 'comp2_semi2_V_dae'});
model.sol('sol3').feature('s2').feature('se1').feature('ss1').set('usesubminsteprecovery', 'auto');
model.sol('sol3').feature('s2').feature('se1').feature('ss1').set('subtermauto', 'tol');
model.sol('sol3').feature('s2').feature('se1').feature('ss1').set('subdtech', 'auto');
model.sol('sol3').feature('s2').feature('se1').feature('ss1').set('subrstep', 10);
model.sol('sol3').feature('s2').feature('se1').feature('ss1').set('subntolfact', 1);
model.sol('sol3').feature('s2').feature('se1').feature('ss1').set('subinitstep', 1);
model.sol('sol3').feature('s2').feature('se1').feature('ss1').set('subminstep', 1.0E-4);
model.sol('sol3').feature('s2').feature('se1').feature('ss1').set('segvarspec', 'all');
model.sol('sol3').feature('s2').feature('se1').feature('ss1').set('subminsteprecovery', 0.75);
model.sol('sol3').feature('s2').feature('se1').feature('ss1').set('maxsubiter', 50);
...
model.sol('sol3').feature('s2').feature('se1').feature('ss2').set('segvar', {'comp2_semi2_smm1_mmct1_Epn' 'comp2_semi2_smm1_mmct1_Epp'});
model.sol('sol3').feature('s2').feature('se1').feature('ss2').set('subtermconst', 'iter');
model.sol('sol3').feature('s2').feature('se1').feature('ss2').set('subdamp', 1);
model.sol('sol3').feature('s2').feature('se1').feature('ss2').set('subjtech', 'onevery');
model.sol('sol3').feature('s2').feature('se1').feature('ss2').set('subdtech', 'const');
model.sol('sol3').feature('s2').feature('se1').feature('ss2').set('subiter', 1);
model.sol('sol3').feature('s2').feature('se1').feature('ss2').set('segvarspec', 'all');
model.sol('sol3').feature('s2').feature('se1').feature('ss2').set('linsolver', 'd1');
model.sol('sol3').feature('s2').feature('se1').set('segterm', 'iter');
model.sol('sol3').feature('s2').feature('se1').set('segiter', 3);
...
model.result('pg7').label('Electron Concentration (semi2)');
...
model.result('pg8').label('Hole Concentration (semi2)');
...
model.result('pg9').label('Electric Potential (semi2)');
...
model.result('pg10').label('Net Dopant Concentration (semi2)');
...
model.result('pg5').run;
model.result('pg5').feature('glob2').label('Global 1 - 3D');
...
model.result('pg6').set('ylabel', 'Jc (A/cm^2)');
model.result('pg6').run;
model.result('pg7').run;
model.result('pg7').label('Electron Concentration & Current Streamlines 3D');
model.result('pg7').create('str1', 'Streamline');
model.result('pg7').feature('str1').label('Streamline 1 - Electron current');
model.result('pg7').feature('str1').set('expr', {'semi2.JnX' 'semi2.JnY' 'semi2.JnZ'});
model.result('pg7').feature('str1').set('descr', 'Electron current density');
...
model.result('pg7').feature('str2').label('Streamline 2 - Hole current');
model.result('pg7').feature('str2').set('expr', {'semi2.JpX' 'semi2.JpY' 'semi2.JpZ'});
model.result('pg7').feature('str2').set('descr', 'Hole current density');
...
model.title('Trench-Gate IGBT 3D');

model.description('In this second half of a two-part example, a 3D model of a trench-gate IGBT is built by extruding the 2D model from the first half. Unlike the 2D model, now it is possible to arrange the alternating n+ and p+ emitters along the direction of extrusion as in the real device. This more realistic arrangement leads to better quantitative agreement with experimental data. The computed collector current density as a function of the collector voltage agrees reasonably well with the published result.');
