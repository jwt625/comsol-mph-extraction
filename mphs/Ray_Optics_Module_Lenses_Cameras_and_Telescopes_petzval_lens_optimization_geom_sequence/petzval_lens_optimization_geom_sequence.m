function out = model
%
% petzval_lens_optimization_geom_sequence.m
%
...
model.param.set('R1_1', '99.56266[mm]', 'L1, surface 1 radius of curvature');
model.param.set('R2_1', '-86.84002[mm]', 'L1, surface 2 radius of curvature');
...
model.param.set('R2_2', '-1187.63858[mm]', 'L2, surface 2 radius of curvature');
...
model.param.set('R1_4', '57.47191[mm]', 'L3, surface 1 radius of curvature');
model.param.set('R2_4', '-54.61865[mm]', 'L3, surface 2 radius of curvature');
...
model.param.set('R2_5', '-614.68633[mm]', 'L4, surface 2 radius of curvature');
...
model.param.set('R1_6', '-38.17110[mm]', 'L5, surface 1 radius of curvature');
