function out = model
%
% submarine_cable_08_d_inductive_effects_3d.m
%
...
model.result.numerical('int4').label('Insulator Losses');
...
model.result.numerical('int4').setIndex('descr', 'Insulator losses (linres 3D)', 0);
model.result.table.create('tbl6', 'Table');
model.result.table('tbl6').comments('Insulator Losses');
model.result.numerical('int4').set('table', 'tbl6');
model.result.numerical('int4').setResult;
model.result.create('pg9', 'PlotGroup3D');
model.result('pg9').run;
model.result('pg9').label('Average Longitudinal Current Density (mf)');
...
model.result('pg9').feature('line1').set('descr', 'Average longitudinal current density');
model.result('pg9').feature('line1').set('expr', 'abs(diskavg(Tarm/2,JL))');
model.result('pg9').run;

model.param('par4').set('i_sc', '0');
model.param('par4').descr('i_sc', 'Auxiliary sweep index (for stabilization compensation)');

model.common.create('state1', 'StateVariables', 'comp1');
model.common('state1').label('Stabilization Compensation');
model.common('state1').selection.named('com1');
model.common('state1').setIndex('state', 'Jex_sc', 0);
...
model.common('state1').setIndex('updateExpression', 'if(i_sc==0,-mf.Jix,Jex_sc)', 0);
model.common('state1').setIndex('description', '', 0);
model.common('state1').setIndex('state', 'Jey_sc', 1);
...
model.common('state1').setIndex('initialValue', 0, 1);
model.common('state1').setIndex('updateExpression', 'if(i_sc==0,-mf.Jiy,Jey_sc)', 1);
model.common('state1').setIndex('description', '', 1);
model.common('state1').setIndex('state', 'Jez_sc', 2);
...
model.common('state1').setIndex('initialValue', 0, 2);
model.common('state1').setIndex('updateExpression', 'if(i_sc==0,-mf.Jiz,Jez_sc)', 2);
model.common('state1').setIndex('description', '', 2);
model.common('state1').set('order', 2);
model.common('state1').set('valueType', 'complex');
model.common('state1').set('update', 'afterStep');

model.physics('mf').create('ecd1', 'ExternalCurrentDensity', 3);
model.physics('mf').feature('ecd1').label('Stabilization Compensation');
model.physics('mf').feature('ecd1').selection.named('com1');
model.physics('mf').feature('ecd1').set('Je', {'if(i_sc==0,0,Jex_sc)' 'if(i_sc==0,0,Jey_sc)' 'if(i_sc==0,0,Jez_sc)'});
model.physics('mf').feature('ecd1').set('ExternalLosses', true);
...
model.study('std1').feature('freq').setIndex('punit_aux', '', 0);
...
model.sol('sol1').feature('s2').create('p1', 'Parametric');
model.sol('sol1').feature('s2').feature.remove('pDef');
model.sol('sol1').feature('s2').feature('p1').set('pname', {'freq' 'i_sc'});
model.sol('sol1').feature('s2').feature('p1').set('punit', {'Hz' ''});
model.sol('sol1').feature('s2').feature('p1').set('sweeptype', 'filled');
model.sol('sol1').feature('s2').feature('p1').set('plistarr', {'f0' '0, 1'});
model.sol('sol1').feature('s2').feature('p1').set('pcontinuationmode', 'no');
model.sol('sol1').feature('s2').feature('p1').set('pcontinuation', '');
model.sol('sol1').feature('s2').feature('p1').set('preusesol', 'yes');
model.sol('sol1').feature('s2').feature('p1').set('pdistrib', 'off');
model.sol('sol1').feature('s2').feature('p1').set('plot', 'off');
model.sol('sol1').feature('s2').feature('p1').set('plotgroup', 'pg1');
model.sol('sol1').feature('s2').feature('p1').set('probesel', 'all');
...
model.result.numerical('int4').setIndex('expr', 'mf.Qh/Lsec', 0);
model.result.numerical('int4').setIndex('unit', 'W/km', 0);
model.result.numerical('int4').setIndex('descr', 'Insulator losses (comstab)', 0);
model.result.table.create('tbl7', 'Table');
model.result.table('tbl7').comments('Insulator Losses');
model.result.numerical('int4').set('table', 'tbl7');
model.result.numerical('int4').setResult;
model.result.numerical('int1').setIndex('expr', 'mf.Qh/Lsec', 0);
model.result.numerical('int1').setIndex('unit', 'W/km', 0);
model.result.numerical('int1').setIndex('descr', 'Phase losses (comstab)', 0);
model.result.numerical('int1').set('table', 'tbl7');
model.result.numerical('int1').appendResult;
model.result.numerical('int2').setIndex('expr', 'mf.Qh/Lsec', 0);
model.result.numerical('int2').setIndex('unit', 'W/km', 0);
model.result.numerical('int2').setIndex('descr', 'Screen losses (comstab)', 0);
model.result.numerical('int2').set('table', 'tbl7');
model.result.numerical('int2').appendResult;
model.result.numerical('int3').setIndex('expr', 'mf.Qh/Lsec', 0);
model.result.numerical('int3').setIndex('unit', 'W/km', 0);
model.result.numerical('int3').setIndex('descr', 'Armor losses (comstab)', 0);
model.result.numerical('int3').set('table', 'tbl7');
model.result.numerical('int3').appendResult;
model.result.numerical('gev1').setIndex('expr', '(mf.RCoil_1/Lsec+mf.RCoil_2/Lsec+mf.RCoil_3/Lsec)/3', 0);
model.result.numerical('gev1').setIndex('unit', 'mohm/km', 0);
model.result.numerical('gev1').setIndex('descr', 'Phase AC resistance (comstab)', 0);
model.result.numerical('gev1').set('table', 'tbl7');
model.result.numerical('gev1').appendResult;
model.result.numerical('gev2').setIndex('expr', '(mf.LCoil_1/Lsec+mf.LCoil_2/Lsec+mf.LCoil_3/Lsec)/3', 0);
model.result.numerical('gev2').setIndex('unit', 'mH/km', 0);
model.result.numerical('gev2').setIndex('descr', 'Phase inductance (comstab)', 0);
...
model.title(['Submarine Cable 8d ' native2unicode(hex2dec({'20' '14'}), 'unicode') ' Inductive Effects 3D']);
