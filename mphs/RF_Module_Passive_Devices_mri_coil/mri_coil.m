...
model.geom('geom1').insertFile('mri_coil_geom_sequence.mph', 'geom1');
...
model.geom('geom1').feature('imp1').set('filename', 'mri_coil.mphbin');
model.geom('geom1').feature('fin').set('repairtoltype', 'absolute');
model.geom('geom1').feature('fin').set('absrepairtol', 2.0E-9);
model.geom('geom1').run('fin');
model.geom('geom1').run('fin');
...
model.selection('sel1').set([9 10 11 12 14 16 19 21 31 33 36 38 66 67 76 77 85 87 90 92 95 97 100 102]);
model.selection.create('sel2', 'Explicit');
model.selection('sel2').model('comp1');
model.selection('sel2').label('Circle');
model.selection('sel2').geom(1);
model.selection('sel2').set([61]);
model.selection('sel2').set('groupcontang', true);
model.selection.create('sel3', 'Explicit');
model.selection('sel3').model('comp1');
model.selection('sel3').label('Absorbing boundaries');
...
model.variable('var1').set('Bleft', 'abs(emw.Bx+j*emw.By)');
model.variable('var1').descr('Bleft', 'Left hand rotating component of magnetic flux');
model.variable('var1').set('Bright', 'abs(emw.Bx-j*emw.By)');
model.variable('var1').descr('Bright', 'Right hand rotating component of magnetic flux');
model.variable('var1').set('BaxialratiodB', '20*log10((Bright+Bleft)/(Bright-Bleft))');
model.variable('var1').descr('BaxialratiodB', 'Magnetic flux axial ratio');
model.variable('var1').set('intBaxialratiodB', 'intop1(abs(BaxialratiodB))');
model.variable('var1').descr('intBaxialratiodB', 'Integration of magnetic flux circularity around the phantom');
model.variable('var1').set('stdev', 'sqrt(aveop1(emw.normE^2)-aveop1(emw.normE)^2)');
model.variable('var1').descr('stdev', 'Standard deviation of E norm');

model.view('view1').hideEntities.create('hide1');
model.view('view1').hideEntities('hide1').geom('geom1', 2);
model.view('view1').hideEntities('hide1').set([1 2 3 4 5 8 23 26 29 63 64 65 68 69 70 71]);
...
model.physics('emw').feature('pec3').selection.set([5 6 65 78]);
model.physics('emw').create('lport1', 'LumpedPort', 2);
model.physics('emw').feature('lport1').selection.set([37]);
model.physics('emw').feature('lport1').set('V0', 200);
model.physics('emw').create('lport2', 'LumpedPort', 2);
model.physics('emw').feature('lport2').selection.set([101]);
...
model.physics('emw').feature('lelement1').selection.set([91]);
model.physics('emw').feature('lelement1').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement1').set('Celement', 'c_value');
model.physics('emw').create('lelement2', 'LumpedElement', 2);
model.physics('emw').feature('lelement2').selection.set([96]);
model.physics('emw').feature('lelement2').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement2').set('Celement', 'c_value');
model.physics('emw').create('lelement3', 'LumpedElement', 2);
model.physics('emw').feature('lelement3').selection.set([86]);
model.physics('emw').feature('lelement3').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement3').set('Celement', 'c_value');
model.physics('emw').create('lelement4', 'LumpedElement', 2);
model.physics('emw').feature('lelement4').selection.set([32]);
model.physics('emw').feature('lelement4').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement4').set('Celement', 'c_value');
model.physics('emw').create('lelement5', 'LumpedElement', 2);
model.physics('emw').feature('lelement5').selection.set([15]);
model.physics('emw').feature('lelement5').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement5').set('Celement', 'c_value');
model.physics('emw').create('lelement6', 'LumpedElement', 2);
model.physics('emw').feature('lelement6').selection.set([20]);
model.physics('emw').feature('lelement6').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement6').set('Celement', 'c_value');
model.physics('emw').create('lelement7', 'LumpedElement', 2);
model.physics('emw').feature('lelement7').selection.set([35]);
model.physics('emw').feature('lelement7').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement7').set('Celement', 'c_value');
model.physics('emw').create('lelement8', 'LumpedElement', 2);
model.physics('emw').feature('lelement8').selection.set([89]);
model.physics('emw').feature('lelement8').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement8').set('Celement', 'c_value');
model.physics('emw').create('lelement9', 'LumpedElement', 2);
model.physics('emw').feature('lelement9').selection.set([99]);
model.physics('emw').feature('lelement9').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement9').set('Celement', 'c_value');
model.physics('emw').create('lelement10', 'LumpedElement', 2);
model.physics('emw').feature('lelement10').selection.set([94]);
model.physics('emw').feature('lelement10').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement10').set('Celement', 'c_value');
model.physics('emw').create('lelement11', 'LumpedElement', 2);
model.physics('emw').feature('lelement11').selection.set([84]);
model.physics('emw').feature('lelement11').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement11').set('Celement', 'c_value');
model.physics('emw').create('lelement12', 'LumpedElement', 2);
model.physics('emw').feature('lelement12').selection.set([30]);
model.physics('emw').feature('lelement12').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement12').set('Celement', 'c_value');
model.physics('emw').create('lelement13', 'LumpedElement', 2);
model.physics('emw').feature('lelement13').selection.set([13]);
model.physics('emw').feature('lelement13').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement13').set('Celement', 'c_value');
model.physics('emw').create('lelement14', 'LumpedElement', 2);
model.physics('emw').feature('lelement14').selection.set([18]);
model.physics('emw').feature('lelement14').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement14').set('Celement', 'c_value');
model.physics('emw').create('lelement15', 'LumpedElement', 2);
model.physics('emw').feature('lelement15').selection.set([39]);
model.physics('emw').feature('lelement15').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement15').set('Celement', 'c_value');
model.physics('emw').create('lelement16', 'LumpedElement', 2);
model.physics('emw').feature('lelement16').selection.set([93]);
model.physics('emw').feature('lelement16').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement16').set('Celement', 'c_value');
model.physics('emw').create('lelement17', 'LumpedElement', 2);
model.physics('emw').feature('lelement17').selection.set([103]);
model.physics('emw').feature('lelement17').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement17').set('Celement', 'c_value');
model.physics('emw').create('lelement18', 'LumpedElement', 2);
model.physics('emw').feature('lelement18').selection.set([98]);
model.physics('emw').feature('lelement18').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement18').set('Celement', 'c_value');
model.physics('emw').create('lelement19', 'LumpedElement', 2);
model.physics('emw').feature('lelement19').selection.set([88]);
model.physics('emw').feature('lelement19').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement19').set('Celement', 'c_value');
model.physics('emw').create('lelement20', 'LumpedElement', 2);
model.physics('emw').feature('lelement20').selection.set([34]);
model.physics('emw').feature('lelement20').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement20').set('Celement', 'c_value');
model.physics('emw').create('lelement21', 'LumpedElement', 2);
model.physics('emw').feature('lelement21').selection.set([17]);
model.physics('emw').feature('lelement21').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement21').set('Celement', 'c_value');
model.physics('emw').create('lelement22', 'LumpedElement', 2);
model.physics('emw').feature('lelement22').selection.set([22]);
model.physics('emw').feature('lelement22').set('LumpedElementType', 'Capacitor');
model.physics('emw').feature('lelement22').set('Celement', 'c_value');
...
model.material('mat2').propertyGroup('def').set('relpermittivity', {'40'});
model.material('mat2').propertyGroup('def').set('relpermeability', {'1'});
model.material('mat2').propertyGroup('def').set('electricconductivity', {'0.9'});
