function out = model
%
% window_and_glazing_thermal_performances_insulation_panel_geom_sequence.m
%
...
model.geom('geom1').feature('sel2').selection('selection').set('ige1', [4 5 7 37 38 39]);
...
model.geom('geom1').feature('sel3').selection('selection').set('ige1', [3 9 40]);
...
model.geom('geom1').feature('sel4').selection('selection').set('ige1', [2 19 23 34 35 36]);
