...
model.result.dataset('ip2').setIndex('genpoints', '1.1694487676997402E-6[mm]', 0, 0);
model.result.dataset('ip2').setIndex('genpoints', '-1.5664895077930253E-5[mm]', 0, 1);
model.result.dataset('ip2').setIndex('genpoints', '162.80059125410654[mm]', 0, 2);
model.result.dataset('ip2').setIndex('genpoints', '2.16944876769974E-6[mm]', 1, 0);
model.result.dataset('ip2').setIndex('genpoints', '-1.5664895077930253E-5[mm]', 1, 1);
model.result.dataset('ip2').setIndex('genpoints', '162.80059125410654[mm]', 1, 2);
model.result.dataset('ip2').setIndex('genpoints', '1.1694487676997402E-6[mm]', 2, 0);
model.result.dataset('ip2').setIndex('genpoints', '-1.4664895077930252E-5[mm]', 2, 1);
model.result.dataset('ip2').setIndex('genpoints', '162.80059125410654[mm]', 2, 2);
model.result('pg6').feature('spot1').run;
model.result.dataset('ip2').set('genmethod', 'threepoint');
model.result.dataset('ip2').setIndex('genpoints', '6.46817916617801E-7[mm]', 0, 0);
model.result.dataset('ip2').setIndex('genpoints', '-1.6322578043786757E-5[mm]', 0, 1);
model.result.dataset('ip2').setIndex('genpoints', '162.79244370311847[mm]', 0, 2);
model.result.dataset('ip2').setIndex('genpoints', '1.646817916617801E-6[mm]', 1, 0);
model.result.dataset('ip2').setIndex('genpoints', '-1.6322578043786757E-5[mm]', 1, 1);
model.result.dataset('ip2').setIndex('genpoints', '162.79244370311847[mm]', 1, 2);
model.result.dataset('ip2').setIndex('genpoints', '6.46817916617801E-7[mm]', 2, 0);
model.result.dataset('ip2').setIndex('genpoints', '-1.5322578043786756E-5[mm]', 2, 1);
model.result.dataset('ip2').setIndex('genpoints', '162.79244370311847[mm]', 2, 2);
