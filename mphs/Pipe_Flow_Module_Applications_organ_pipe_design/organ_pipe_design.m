...
model.description(['This app demonstrates the following:' newline  newline  native2unicode(hex2dec({'20' '22'}), 'unicode') ' Using a Java' native2unicode(hex2dec({'00' 'ae'}), 'unicode') ' utility class for combining several waveforms and for playing sound' newline  native2unicode(hex2dec({'20' '22'}), 'unicode') ' Using tables for presenting results' newline  newline 'The app allows you to study the design of an organ pipe and then play the sound and pitch of the changed design. The pipe sound includes the effects of different harmonics with different amplitudes.' newline  newline 'The organ pipe is modeled using the Pipe Acoustics, Frequency Domain interface. The app allows you to analyze how the first fundamental resonance frequency varies with the pipe radius and wall thickness, as well as with the ambient pressure and temperature.' newline  newline 'In the app you can find the full frequency response, including the fundamental frequency and the harmonics. With a method written in Java' native2unicode(hex2dec({'00' 'ae'}), 'unicode') ' code, the app detects the location and amplitude of all harmonics in the response, thus extending the analysis beyond the built-in functionality of the COMSOL Multiphysics user interface.']);
...
model.result('pg3').set('title', 'Pipe Diameters');
model.result('pg4').run;
model.result('pg4').set('xlabelactive', true);
model.result('pg4').set('xlabel', 'f (Hz)');
model.result('pg4').set('titletype', 'manual');
model.result('pg4').set('title', 'Wall Thicknesses');
model.result('pg5').run;
model.result('pg5').set('xlabelactive', true);
model.result('pg5').set('xlabel', 'f (Hz)');
model.result('pg5').set('titletype', 'manual');
model.result('pg5').set('title', 'Pipe Resonance Frequencies');
model.result.report.create('rpt1', 'Report');
model.result.report('rpt1').label('Application Report');
...
model.result.report('rpt1').feature('sec1').feature('txt1').label('Study: different pipe diameters');
model.result.report('rpt1').feature('sec1').feature('txt1').set('text', '<s>Study: different pipe diameters</s>');
model.result.report('rpt1').feature('sec1').feature.create('std1', 'Study');
model.result.report('rpt1').feature('sec1').feature('std1').label('Study: different pipe diameters');
...
model.result.report('rpt1').feature('sec1').feature('txt2').label('Study: different wall thicknesses');
model.result.report('rpt1').feature('sec1').feature('txt2').set('text', '<s>Study: different wall thicknesses</s>');
model.result.report('rpt1').feature('sec1').feature.create('std2', 'Study');
model.result.report('rpt1').feature('sec1').feature('std2').label('Study: different wall thicknesses');
...
model.result.report('rpt1').feature('sec1').feature('txt3').label('Study: pipe resonance frequencies');
model.result.report('rpt1').feature('sec1').feature('txt3').set('text', '<s>Study: pipe resonance frequencies</s>');
model.result.report('rpt1').feature('sec1').feature.create('std3', 'Study');
model.result.report('rpt1').feature('sec1').feature('std3').label('Study: pipe resonance frequencies');
...
model.result.report('rpt1').feature('sec2').label('Input: Organ Pipe Properties');
...
model.result.report('rpt1').feature('sec2').feature('img1').set('externalfile', 'embedded:///organ_pipe_design_sketch.png');
model.result.report('rpt1').feature('sec2').feature('img1').set('caption', 'Schematic design.');
model.result.report('rpt1').feature('sec2').feature.create('param1', 'Parameter');
model.result.report('rpt1').feature('sec2').feature('param1').set('children', {'f' 'off';  ...
'Lguess' 'off';  ...
'L' 'off';  ...
'd' 'off';  ...
'a' 'off';  ...
...
model.result.report('rpt1').feature('sec3').label('Input: Control Conditions');
model.result.report('rpt1').feature('sec3').feature.create('param1', 'Parameter');
model.result.report('rpt1').feature('sec3').feature('param1').set('children', {'f' 'off';  ...
'Lguess' 'off';  ...
'L' 'off';  ...
'd' 'off';  ...
'a' 'off';  ...
...
model.result.report('rpt1').feature('sec4').label('Detailed Results');
model.result.report('rpt1').feature('sec4').feature.create('sec1', 'Section');
model.result.report('rpt1').feature('sec4').feature('sec1').label('Response: different pipe diameters');
...
model.result.report('rpt1').feature('sec4').feature('sec2').label('Response: different wall thicknesses');
...
model.result.report('rpt1').feature('sec4').feature('sec3').label('Response: pipe resonance frequencies');
