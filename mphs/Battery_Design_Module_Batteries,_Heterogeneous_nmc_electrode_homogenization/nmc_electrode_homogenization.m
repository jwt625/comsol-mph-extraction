function out = model
%
% nmc_electrode_homogenization.m
%
...
model.param.set('Vp', '2.2563069890425415E-14[m^3]');

model.geom('geom1').measure.selection.init(2);
model.geom('geom1').measure.selection.named('intsel1');

model.param.set('Ap', '1.1896275303547041E-8[m^2]');
...
model.physics('lpeq').selection.named('geom1_comsel2');
model.physics('lpeq').create('dir1', 'DirichletBoundary', 2);
model.physics('lpeq').feature('dir1').selection.set([18]);
model.physics('lpeq').create('dir2', 'DirichletBoundary', 2);
model.physics('lpeq').feature('dir2').selection.set([3]);
model.physics('lpeq').feature('dir2').setIndex('r', 1, 0);
...
model.result('pg1').label('Dependent Variable u');
model.result('pg1').run;
model.result.create('pg2', 'PlotGroup3D');
model.result('pg2').run;
model.result('pg2').label('Flux');
...
model.result.numerical('av1').label('Surface Average - Effective Flux Factor');
model.result.numerical('av1').selection.set([3]);
model.result.numerical('av1').set('expr', {'dflux.u'});
model.result.numerical('av1').set('descr', {'Boundary flux down direction'});
model.result.numerical('av1').set('unit', {'1/m'});
model.result.numerical('av1').setIndex('expr', 'dflux.u*L_elec', 0);
model.result.numerical('av1').setIndex('descr', 'Effective flux factor', 0);
model.result.table.create('tbl2', 'Table');
model.result.table('tbl2').comments('Surface Average - Effective Flux Factor');
model.result.numerical('av1').set('table', 'tbl2');
model.result.numerical('av1').setResult;

model.param.set('f_eff', '0.554');
model.param.descr('f_eff', 'Effective flux factor');
model.param.create('par2');
model.param('par2').label('Electrode Parameters');

% To import content from file, use:
% model.param('par2').loadFile('FILENAME');
model.param('par2').set('eps_l_b', '0.9', 'Electrolyte volume fraction in binder');
model.param('par2').set('eps_s_b', '0.1', 'Carbon filler volume fraction in binder');
model.param('par2').set('csmax', '49000[mol/m^3]', 'Maximum lithium concentration in particle');
model.param('par2').set('socmax', '0.975', 'Maximum particle lithiation level');
model.param('par2').set('socmin', '0.01', 'Minimum particle lithiation level');
model.param('par2').set('Capacity', 'csmax*(socmax-socmin)*F_const*Vp', 'Nominal capacity of electrode');
model.param('par2').set('I_1C', 'Capacity/1[h]', '1C discharge current');
model.param('par2').set('cs0', 'csmax*socinit', 'Initial lithium concentration in particles');
model.param('par2').set('sigma_s', '1[S/m]', 'Porous conductive binder conductivity');
model.param('par2').set('C_rate', '2', 'Discharge C rate');
model.param('par2').set('socinit', 'socmin+0.5*0', 'Initial lithiation level, nmc (use 0.5 for EIS study, socmin for discharge)');
model.param('par2').set('epsl_sep', '0.4', 'Electrolyte volume fraction in separator');
model.param('par2').set('i0_ref_NMC', '10[A/m^2]', 'Reference exchange current density for lithium intercalation into NMC');
model.param('par2').set('i0_ref_Li', '100[A/m^2]', 'Reference exchange current density for lithium deposition/dissolution');
model.param('par2').set('C_dl_NMC', '0.2[F/m^2]', 'Double layer capacitance, NMC particles');
...
model.geom('geom2').feature('i1').setIndex('len', 'L_sep', 0);
model.geom('geom2').feature('i1').setIndex('len', 'L_elec', 1);
model.geom('geom2').run('i1');

model.physics.create('liion', 'LithiumIonBatteryMPH', 'geom2');
model.physics('liion').model('comp2');
...
model.material('mat2').label('Lithium Metal, Li (Negative, Li-ion Battery)');
...
model.material('mat2').propertyGroup('def').set('poissonsratio', '0.34');
model.material('mat2').propertyGroup('def').set('INFO_PREFIX:poissonsratio', 'Yue Qi et al 2010 J. Electrochem. Soc. 157 A558');
model.material('mat2').propertyGroup('def').set('density', '0.534[g/cm^3]');
model.material('mat2').propertyGroup('def').set('INFO_PREFIX:density', 'https://en.wikipedia.org/wiki/Lithium');
model.material('mat2').propertyGroup('def').set('thermalconductivity', {'84.8[W/(m*K)]' '0' '0' '0' '84.8[W/(m*K)]' '0' '0' '0' '84.8[W/(m*K)]'});
model.material('mat2').propertyGroup('def').set('INFO_PREFIX:thermalconductivity', 'https://en.wikipedia.org/wiki/Lithium');
model.material('mat2').propertyGroup('def').set('electricconductivity', {['1/(92.8[n' 'ohm' '*m])'] '0' '0' '0' ['1/(92.8[n' 'ohm' '*m])'] '0' '0' '0' ['1/(92.8[n' 'ohm' '*m])']});
model.material('mat2').propertyGroup('def').set('INFO_PREFIX:electricconductivity', 'https://en.wikipedia.org/wiki/Lithium');
model.material('mat2').propertyGroup('def').set('heatcapacity', '3.58[kJ/kg/K]');
model.material('mat2').propertyGroup('def').set('INFO_PREFIX:heatcapacity', 'https://en.wikipedia.org/wiki/Lithium');
model.material('mat2').propertyGroup('ElectrodePotential').set('Eeq', '0[V]');
model.material('mat2').propertyGroup('ElectrodePotential').set('dEeqdT', '0[V/K]');
model.material('mat2').propertyGroup('ElectrodePotential').set('cEeqref', '0[M]');
...
model.material('mat2').selection.geom('geom2', 0);
model.material('mat2').selection.set([1]);
model.material('mat3').selection.all;

model.physics('liion').prop('Ac').set('Ac', 'A_cross');
...
model.physics('liion').feature('pce1').set('epss', 'eps_particles');
model.physics('liion').feature('pce1').set('epsl', 'eps_l_b*eps_binder');
model.physics('liion').feature('pce1').set('IonicCorrModel', 'userdef');
model.physics('liion').feature('pce1').set('fl', 'f_eff*(eps_l_b^1.5)');
model.physics('liion').feature('pce1').set('ElectricCorrModel', 'userdef');
model.physics('liion').feature('pce1').set('fs', 'f_eff');
model.physics('liion').feature('pce1').set('DiffusionCorrModel', 'userdef');
model.physics('liion').feature('pce1').set('fDl', 'f_eff*(eps_l_b^1.5)');
model.physics('liion').feature('pce1').feature('pin1').set('ParticleMaterial', 'mat1');
model.physics('liion').feature('pce1').feature('pin1').set('csinit', 'cs0');
model.physics('liion').feature('pce1').feature('pin1').set('rp', 'rp_avg_spheres');
model.physics('liion').feature('pce1').feature('per1').set('MaterialOption', 'mat1');
model.physics('liion').feature('pce1').feature('per1').set('i0_ref', 'i0_ref_NMC');
model.physics('liion').feature('pce1').feature('per1').set('ActiveSpecificSurfaceAreaType', 'userdef');
model.physics('liion').feature('pce1').feature('per1').set('Av', 'Av_particles');
model.physics('liion').create('es1', 'ElectrodeSurface', 0);
model.physics('liion').feature('es1').selection.set([1]);
model.physics('liion').feature('es1').feature('er1').set('i0_ref', 'i0_ref_Li');
model.physics('liion').create('ec1', 'ElectrodeCurrent', 0);
model.physics('liion').feature('ec1').selection.set([3]);
model.physics('liion').feature('ec1').set('Its', '-I_1C*C_rate');

model.cpl.create('intop1', 'Integration', 'geom2');
model.cpl('intop1').set('axisym', true);
model.cpl('intop1').selection.geom('geom2', 0);
model.cpl('intop1').selection.set([3]);
model.cpl('intop1').set('opname', 'intop_nmc_cc');
...
model.study('std2').feature('cdi').setEntry('activate', 'lpeq', false);
...
model.study('std2').feature('time').setEntry('activate', 'lpeq', false);
...
model.sol('sol2').feature('v1').feature('comp2_phis').set('scalemethod', 'manual');
model.sol('sol2').feature('v1').feature('comp2_phil').set('scalemethod', 'manual');
model.sol('sol2').feature('v1').feature('comp2_liion_ec1_phis0').set('scalemethod', 'manual');
model.sol('sol2').feature('v1').feature('comp2_cl').set('scalemethod', 'manual');
model.sol('sol2').feature('v1').feature('comp2_phis').set('scaleval', '1');
model.sol('sol2').feature('v1').feature('comp2_phil').set('scaleval', '1');
model.sol('sol2').feature('v1').feature('comp2_liion_ec1_phis0').set('scaleval', '1');
model.sol('sol2').feature('v1').feature('comp2_cl').set('scaleval', '1000');
...
model.sol('sol2').feature('s1').feature('d1').label('Direct (liion)');
model.sol('sol2').feature('s1').create('i1', 'Iterative');
model.sol('sol2').feature('s1').feature('i1').set('maxlinit', 1000);
model.sol('sol2').feature('s1').feature('i1').set('nlinnormuse', 'on');
model.sol('sol2').feature('s1').feature('i1').label('Algebraic Multigrid (liion)');
...
model.sol('sol2').feature('s1').feature('i2').label('Geometric Multigrid (liion)');
...
model.sol('sol2').feature('v2').feature('comp2_liion_pce1_cs').set('scalemethod', 'manual');
model.sol('sol2').feature('v2').feature('comp2_phis').set('scalemethod', 'manual');
model.sol('sol2').feature('v2').feature('comp2_phil').set('scalemethod', 'manual');
model.sol('sol2').feature('v2').feature('comp2_liion_ec1_phis0').set('scalemethod', 'manual');
model.sol('sol2').feature('v2').feature('comp2_cl').set('scalemethod', 'manual');
model.sol('sol2').feature('v2').feature('comp2_liion_pce1_cs').set('scaleval', '10000');
model.sol('sol2').feature('v2').feature('comp2_phis').set('scaleval', '1');
model.sol('sol2').feature('v2').feature('comp2_phil').set('scaleval', '1');
model.sol('sol2').feature('v2').feature('comp2_liion_ec1_phis0').set('scaleval', '1');
model.sol('sol2').feature('v2').feature('comp2_cl').set('scaleval', '1000');
...
model.sol('sol2').feature('t1').set('tlist', 'range(0,0.1/C_rate,0.9/C_rate)');
...
model.result('pg3').feature('glob1').set('expr', {'liion.phis0_ec1'});
model.result('pg3').feature('glob1').set('descr', {'Electric potential on boundary'});
model.result('pg3').label('Boundary Electrode Potential with Respect to Ground (liion)');
model.result('pg3').feature('glob1').set('xdatasolnumtype', 'level1');
model.result.create('pg4', 'PlotGroup1D');
model.result('pg4').set('data', 'dset3');
model.result('pg4').create('glob1', 'Global');
model.result('pg4').feature('glob1').set('unit', {''});
model.result('pg4').feature('glob1').set('expr', {'liion.soc_average_pce1'});
model.result('pg4').feature('glob1').set('descr', {'Average SOC, Porous Electrode 1'});
model.result('pg4').label('Average Electrode State of Charge (liion)');
model.result('pg4').feature('glob1').set('xdatasolnumtype', 'level1');
model.result.create('pg5', 'PlotGroup1D');
model.result('pg5').set('data', 'dset3');
model.result('pg5').label('Electrolyte Potential (liion)');
...
model.result('pg5').feature('lngr1').set('expr', {'phil'});
...
model.result('pg6').feature('lngr1').set('expr', {'phis'});
...
model.physics('liion').feature('pce1').feature('pdl1').set('Cdl', 'C_dl_NMC');
model.physics('liion').feature('pce1').feature('pdl1').set('ActiveSpecificSurfaceAreaType', 'userdef');
model.physics('liion').feature('pce1').feature('pdl1').set('av_dl', 'Av_particles');
model.physics('liion').feature.duplicate('ec2', 'ec1');
model.physics('liion').feature('ec2').label('Electrode Current - Harmonic Perturbation');
model.physics('liion').feature('ec2').set('Its', 0);
model.physics('liion').feature('ec2').create('hp1', 'HarmonicPerturbation', 0);
model.physics('liion').feature('ec2').feature('hp1').set('deltaIts', 'I_1C/20');
...
model.study('std3').feature('frlin').setEntry('activate', 'lpeq', false);
...
model.study('std3').feature('cdi').setEntry('activate', 'lpeq', false);
...
model.sol('sol4').feature('st1').set('studystep', 'cdi');
model.sol('sol4').create('v1', 'Variables');
model.sol('sol4').feature('v1').feature('comp2_liion_ec2_phis0').set('scalemethod', 'manual');
model.sol('sol4').feature('v1').feature('comp2_phis').set('scalemethod', 'manual');
model.sol('sol4').feature('v1').feature('comp2_phil').set('scalemethod', 'manual');
model.sol('sol4').feature('v1').feature('comp2_cl').set('scalemethod', 'manual');
model.sol('sol4').feature('v1').feature('comp2_liion_ec2_phis0').set('scaleval', '1');
model.sol('sol4').feature('v1').feature('comp2_phis').set('scaleval', '1');
model.sol('sol4').feature('v1').feature('comp2_phil').set('scaleval', '1');
model.sol('sol4').feature('v1').feature('comp2_cl').set('scaleval', '1000');
model.sol('sol4').feature('v1').set('control', 'cdi');
...
model.sol('sol4').feature('s1').feature('d1').label('Direct (liion)');
...
model.sol('sol4').feature('s1').feature('i1').label('Algebraic Multigrid (liion)');
...
model.sol('sol4').feature('s1').feature('i1').feature('mg1').set('compactaggregation', true);
...
model.sol('sol4').feature('s1').feature('i2').label('Geometric Multigrid (liion)');
...
model.sol('sol4').feature('s2').feature('p1').set('plistarr', {'10^range(-2.6,0.2,5)'});
...
model.result('pg8').feature('nyq1').set('unit', {''});
model.result('pg8').feature('nyq1').set('expr', {'conj(liion.Zvsgrnd_ec2) '});
model.result('pg8').feature('nyq1').set('descr', {''});
model.result('pg8').label('Impedance with Respect to Ground, Nyquist (liion)');
model.result('pg8').feature('nyq1').setIndex('descr', 'Impedance with Respect to Ground', 0);
...
model.result('pg9').feature('glob1').set('expr', {'real(conj(liion.Zvsgrnd_ec2)) '});
model.result('pg9').feature('glob1').set('descr', {''});
model.result('pg9').label('Impedance with Respect to Ground, Real Part (liion)');
model.result('pg9').feature('glob1').setIndex('descr', 'Impedance with Respect to Ground, Real Part', 0);
...
model.result('pg10').feature('glob1').set('expr', {'imag(conj(liion.Zvsgrnd_ec2)) '});
model.result('pg10').feature('glob1').set('descr', {''});
model.result('pg10').label('Impedance with Respect to Ground, Imaginary Part (liion)');
model.result('pg10').feature('glob1').setIndex('descr', 'Impedance with Respect to Ground, Imaginary Part', 0);
...
model.result.table('tbl3').label('Heterogeneous Discharge Data (Imported)');
model.result.table('tbl3').importData('nmc_electrode_heterogeneous_discharge_data.txt');
model.result.table.create('tbl4', 'Table');
model.result.table('tbl4').label('Heterogeneous EIS Data (Imported)');
model.result.table('tbl4').importData('nmc_electrode_heterogeneous_eis_data.txt');
model.result('pg3').run;
model.result('pg3').label('Discharge Voltage');
...
model.result('pg3').feature('tblp1').setIndex('legends', 'Heterogeneous', 0);
model.result('pg3').run;
model.result('pg3').feature('glob1').set('legendmethod', 'manual');
model.result('pg3').feature('glob1').setIndex('legends', 'Homogeneous', 0);
model.result('pg3').run;
model.result('pg8').run;
...
model.result('pg8').feature('tblp1').setIndex('legends', 'Heterogeneous', 0);
model.result('pg8').run;
model.result('pg8').run;
model.result('pg8').feature('nyq1').set('legendmethod', 'manual');
model.result('pg8').feature('nyq1').setIndex('legends', 'Homogeneous', 0);
model.result('pg8').run;
...
model.study('std2').feature('cdi').set('disabledphysics', {'liion/ec2'});
model.study('std2').feature('time').set('useadvanceddisable', true);
model.study('std2').feature('time').set('disabledphysics', {'liion/ec2'});
model.study('std1').feature('stat').setEntry('activate', 'liion', false);

model.param('par2').set('socinit', 'socmin+0.5*0');

model.title('Homogenizing a Heterogeneous Electrode Model');

model.description(['This example demonstrates how to calculate effective transport properties of a heterogeneous 3D geometry of a nickel manganese cobalt (NMC) electrode.' newline  newline 'The effective parameters are then used to create a representative homogenized 1D model of the NMC electrode. By homogenizing, memory requirements and computational times are reduced by orders of magnitude.']);
