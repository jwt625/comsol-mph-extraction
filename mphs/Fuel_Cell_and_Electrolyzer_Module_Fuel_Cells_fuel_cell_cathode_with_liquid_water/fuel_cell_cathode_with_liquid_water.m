function out = model
%
% fuel_cell_cathode_with_liquid_water.m
%
...
model.study('std1').feature('cdi').set('errorexpr', {'1'});
...
model.material('mat1').propertyGroup('ElectrolyteConductivity').func('int1').set('importedstruct', 'Spreadsheet');
...
model.study('std1').feature('cdi').set('notlistsolnum', 1);
model.study('std1').feature('cdi').set('notsolnum', 'auto');
model.study('std1').feature('cdi').set('listsolnum', 1);
model.study('std1').feature('cdi').set('solnum', 'auto');
...
model.result('pg16').label('Relative Humidity');
model.result('pg16').create('vol1', 'Volume');
model.result('pg16').feature('vol1').set('expr', 'fc.RH');
model.result('pg16').feature('vol1').set('descr', 'Relative humidity');
model.result('pg16').feature('vol1').create('sel1', 'Selection');
model.result('pg16').feature('vol1').feature('sel1').selection.named('geom1_blk2_dom');
model.result('pg16').run;
model.result.table.duplicate('tbl3', 'tbl1');
model.result.table('tbl3').label('Oversaturated, no liquid water transport');

model.physics.create('phtr', 'PhaseTransportPorousMedia', 'geom1', {'s_g' 's_l'});

model.study('std1').feature('cdi').setSolveFor('/physics/phtr', true);
model.study('std1').feature('stat').setSolveFor('/physics/phtr', true);

model.param.rename('eps_gas', 'eps_pores');
model.param.descr('eps_pores', 'Pore volume fraction in porous electrode');
model.param.set('kce', '5.62e4[mol/m^3/s]');
model.param.descr('kce', 'Condensation evaporation rate constant');
...
model.variable('var1').set('eps_gas', 'eps_pores*s_g', 'Gas volume fraction');
model.variable('var1').set('pc', 'pc(s_l)', 'Capillary pressure');
model.variable('var1').set('perm_eff_gas', 'perm*s_g^2', 'Effective gas phase permeability');

model.func.create('int1', 'Interpolation');
model.func('int1').model('comp1');
model.func('int1').set('source', 'file');
model.func('int1').set('filename', 'fuel_cell_cathode_with_liquid_water_pc.txt');
model.func('int1').importData;
model.func('int1').set('funcname', 'pc');
...
model.func('int1').set('funcinvname', 's_l');

model.physics('fc').prop('O2GasMixture').set('H2O_l', true);
model.physics('fc').feature('o2gasph1').create('wce1', 'WaterCondensationEvaporation', 3);
model.physics('fc').feature('o2gasph1').feature('wce1').set('k_ce', 'kce');
model.physics('fc').feature('o2gde1').set('kappag', {'perm_eff_gas' '0' '0' '0' 'perm_eff_gas' '0' '0' '0' 'perm_eff_gas'});
model.physics('phtr').selection.named('geom1_blk2_dom');
model.physics('phtr').feature('pptp1').set('minput_pressure', 'fc.pA');
model.physics('phtr').feature('pptp1').setIndex('pc', 'pc', 1);
model.physics('phtr').feature('pptp1').set('rhoint_s_g_mat', 'root.comp1.fc.rho');
model.physics('phtr').feature('pptp1').set('mu_s_g_mat', 'root.comp1.fc.mu');
model.physics('phtr').feature('pptp1').set('rhoint_s_l_mat', 'root.comp1.fc.rhoH2O_l');
model.physics('phtr').feature('pptp1').set('mu_s_l_mat', 'root.comp1.fc.muH2O_l');
model.physics('phtr').feature('pptp1').set('epsilon_p_mat', 'userdef');
model.physics('phtr').feature('pptp1').set('epsilon_p', 'eps_pores');
model.physics('phtr').feature('pptp1').set('kappa_mat', 'userdef');
model.physics('phtr').feature('pptp1').set('kappa', {'perm' '0' '0' '0' 'perm' '0' '0' '0' 'perm'});
model.physics('phtr').create('sa1', 'VolumeFraction', 2);
model.physics('phtr').feature('sa1').selection.named('geom1_wp1_bnd');
model.physics('phtr').feature('sa1').setIndex('phases', true, 1);
model.physics('phtr').feature('sa1').setIndex('s0', 's_l(0)', 1);
model.physics('phtr').feature('init1').setIndex('s0', 's_l(0)', 1);
model.physics('phtr').create('ms1', 'MassSource', 3);
model.physics('phtr').feature('ms1').selection.all;
model.physics('phtr').feature('ms1').setIndex('qs_s_l_src', 'root.comp1.fc.Q_l', 0);

model.study('std1').create('stat2', 'Stationary');
model.study('std1').feature('stat2').label('Stationary - Excluding Phase Transport');
model.study('std1').feature('stat2').setEntry('activate', 'phtr', false);
model.study('std1').feature.move('stat2', 1);
model.study('std1').create('stat3', 'Stationary');
model.study('std1').feature('stat3').label('Stationary - Phase Transport Only');
model.study('std1').feature('stat3').setEntry('activate', 'fc', false);
model.study('std1').feature.move('stat3', 2);
model.study('std1').feature('stat').label('Stationary - All Physics');
...
model.study('std1').feature('stat3').set('solvertype', 'solnum');
model.study('std1').feature('stat3').set('solnumhide', 'off');
model.study('std1').feature('stat3').set('initstudyhide', 'off');
model.study('std1').feature('stat3').set('initsolhide', 'off');
...
model.sol('sol1').feature('v3').feature('comp1_s_l').set('scalemethod', 'manual');
model.sol('sol1').feature('v3').feature('comp1_s_l').set('scaleval', '1');
...
model.sol('sol1').feature('s3').feature('fc1').set('damp', 0.6);
model.sol('sol1').feature('s3').feature('fc1').set('maxiter', 150);
model.sol('sol1').feature('s3').feature('fc1').set('stabacc', 'cflcmp');
model.sol('sol1').feature('s3').feature('fc1').set('initcfl', 5);
...
model.sol('sol1').feature('s3').feature('d1').label('Direct, volume fractions (phtr)');
...
model.sol('sol1').feature('s3').feature('i1').label('AMG, volume fractions (phtr)');
...
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('pr').feature('sl1').set('linesweeptype', 'sor');
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('pr').feature('sl1').set('iter', 1);
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('pr').feature('sl1').set('linerelax', 0.6);
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('pr').feature('sl1').set('linealgorithm', 'matrix');
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('pr').feature('sl1').set('linemethod', 'uncoupled');
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('pr').feature('sl1').set('seconditer', 1);
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('pr').feature('sl1').set('relax', 0.4);
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('pr').feature('sl1').set('maxline', 15);
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('po').create('sl1', 'SORLine');
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('po').feature('sl1').set('linesweeptype', 'soru');
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('po').feature('sl1').set('iter', 1);
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('po').feature('sl1').set('linerelax', 0.6);
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('po').feature('sl1').set('linealgorithm', 'matrix');
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('po').feature('sl1').set('linemethod', 'uncoupled');
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('po').feature('sl1').set('seconditer', 1);
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('po').feature('sl1').set('relax', 0.4);
model.sol('sol1').feature('s3').feature('i1').feature('mg1').feature('po').feature('sl1').set('maxline', 15);
...
model.sol('sol1').feature('st4').set('studystep', 'stat');

model.study('std1').feature('stat').set('initsoluse', 'sol2');

model.sol('sol1').create('v4', 'Variables');
model.sol('sol1').feature('v4').feature('comp1_fc_phis').set('scalemethod', 'manual');
model.sol('sol1').feature('v4').feature('comp1_fc_wH2O_O2').set('scalemethod', 'manual');
...
model.sol('sol1').feature('v4').feature('comp1_s_l').set('scalemethod', 'manual');
model.sol('sol1').feature('v4').feature('comp1_fc_phis').set('scaleval', '1');
model.sol('sol1').feature('v4').feature('comp1_fc_wH2O_O2').set('scaleval', '1');
...
model.sol('sol1').feature('v4').feature('comp1_s_l').set('scaleval', '1');
...
model.sol('sol1').feature('v4').set('control', 'stat');
...
model.sol('sol1').feature('s4').feature('p1').set('control', 'stat');
model.sol('sol1').feature('s4').set('control', 'stat');
...
model.sol('sol1').feature('s4').feature('se1').feature('ss1').set('segvar', {'comp1_fc_phil' 'comp1_fc_phis' 'comp1_fc_wH2O_O2' 'comp1_fc_wN2_O2' 'comp1_fc_p_O2'});
...
model.sol('sol1').feature('s4').feature('se1').feature('ss2').set('segvar', {'comp1_s_l'});
model.sol('sol1').feature('s4').feature('se1').feature('ss2').set('subdamp', 0.5);
model.sol('sol1').feature('s4').feature('se1').feature('ss2').set('subiter', 2);
...
model.sol('sol1').feature('s4').feature('d2').label('Direct, volume fractions (phtr)');
model.sol('sol1').feature('s4').feature('se1').feature('ss2').set('linsolver', 'd2');
model.sol('sol1').feature('s4').feature('se1').feature('ss2').label('Volume Fractions');
...
model.sol('sol1').feature('s4').feature('i3').label('AMG, volume fractions (phtr)');
...
model.sol('sol1').feature('s4').feature('i3').feature('mg1').set('saamgcompwise', false);
...
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('pr').feature('sl1').set('linesweeptype', 'sor');
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('pr').feature('sl1').set('iter', 1);
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('pr').feature('sl1').set('linerelax', 0.6);
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('pr').feature('sl1').set('linealgorithm', 'matrix');
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('pr').feature('sl1').set('linemethod', 'uncoupled');
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('pr').feature('sl1').set('seconditer', 1);
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('pr').feature('sl1').set('relax', 0.4);
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('pr').feature('sl1').set('maxline', 15);
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('po').create('sl1', 'SORLine');
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('po').feature('sl1').set('linesweeptype', 'soru');
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('po').feature('sl1').set('iter', 1);
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('po').feature('sl1').set('linerelax', 0.6);
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('po').feature('sl1').set('linealgorithm', 'matrix');
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('po').feature('sl1').set('linemethod', 'uncoupled');
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('po').feature('sl1').set('seconditer', 1);
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('po').feature('sl1').set('relax', 0.4);
model.sol('sol1').feature('s4').feature('i3').feature('mg1').feature('po').feature('sl1').set('maxline', 15);
...
model.study('std1').feature('stat').set('initsoluse', 'sol4');
...
model.result('pg17').label('Liquid Water Saturation');
model.result('pg17').create('vol1', 'Volume');
model.result('pg17').feature('vol1').set('expr', 's_l');
model.result('pg17').feature('vol1').set('descr', 'Volume fraction');
model.result('pg17').run;
model.result('pg17').run;
model.result('pg17').create('arws1', 'ArrowSurface');
model.result('pg17').feature('arws1').set('expr', {'phtr.ux_s_l' 'phtr.uy_s_l' 'phtr.uz_s_l'});
model.result('pg17').feature('arws1').set('descr', 'Volumetric flux, phase s_l');
model.result('pg17').feature('arws1').set('arrowcount', 50);
model.result('pg17').feature('arws1').set('color', 'black');
model.result('pg17').feature('arws1').create('sel1', 'Selection');
model.result('pg17').feature('arws1').feature('sel1').selection.set([10]);
model.result('pg17').run;
model.result.create('pg18', 'PlotGroup3D');
model.result('pg18').run;
model.result('pg18').label('Capillary Pressure');
model.result('pg18').create('vol1', 'Volume');
model.result('pg18').feature('vol1').set('expr', 'pc');
model.result('pg18').feature('vol1').set('descr', 'Capillary pressure');
model.result('pg18').feature('vol1').set('unit', 'mbar');
model.result('pg18').run;
model.result('pg3').set('window', 'window1');
model.result('pg3').run;
model.result('pg3').set('window', 'window1');
model.result('pg3').run;
model.result('pg3').feature('tblp1').setIndex('legends', 'With liquid water', 0);
model.result('pg3').set('window', 'window1');
model.result('pg3').run;
model.result('pg3').feature('tblp2').set('table', 'tbl3');
model.result('pg3').feature('tblp2').setIndex('legends', 'Oversaturated, no liquid water', 0);
model.result('pg3').set('window', 'window1');
model.result('pg3').run;
model.result.table.remove('tbl2');

model.func('int1').createPlot('pg19');

model.result('pg19').run;
model.result('pg19').set('xlabelactive', true);
model.result('pg19').set('xlabel', 'Liquid saturation (1)');
model.result('pg19').set('ylabelactive', true);
model.result('pg19').set('ylabel', 'Capillary pressure (bar)');
model.result('pg19').set('titletype', 'none');
model.result('pg19').run;
model.result.remove('pg19');
model.result.dataset.remove('int1_ds1');
model.result('pg12').run;
model.result('pg12').label('Gas Phase Pressure');

model.title('Fuel Cell Cathode with Liquid Water');

model.description(['This example extends the Mass Transport and Electrochemical Reaction in a Fuel Cell Cathode tutorial to also include liquid water transport in the oxygen electrode.' newline  newline 'Liquid water is produced using a rate expression for vapor condensation, depending on the relative humidity level in the gas phase.' newline  newline 'An experimental capillary pressure curve is used to define the correlation between the liquid saturation level and the difference between the liquid and gas phase pressures.']);
...
model.label('fuel_cell_cathode_with_liquid_water.mph');
