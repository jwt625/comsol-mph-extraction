...
model.variable('var1').set('C_scatt', 'intop1(nr*ewfd.relPoavr+nz*ewfd.relPoavz)/I0');
...
model.physics('ewfd').prop('BackgroundField').set('WaveType', 'LinearPol');
model.physics('ewfd').prop('BackgroundField').set('incAngle', 'theta');
model.physics('ewfd').prop('BackgroundField').set('highestMode', 5);
model.physics('ewfd').prop('BackgroundField').set('fieldAmplitude', 'E0');
...
model.physics('ewfd').prop('outofplanewavenumber').set('mFloquet', 'modeNum');
...
model.physics('ewfd').feature('trans1').selection.set([8 10 16]);
...
model.physics('ewfd').feature('trans1').set('sigmabnd', 'sigma/d_eff');
model.physics('ewfd').feature('trans1').set('d', 'd_eff');
...
model.study('std2').feature('freq').set('disabledphysics', {'ewfd/trans1'});
...
model.result('pg2').label('Scattered Field (ewfd)');
model.result('pg2').create('surf1', 'Surface');
model.result('pg2').feature('surf1').set('expr', 'sum(withsol(''sol1'',ewfd.relEz,setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)');
...
model.result('pg3').label('Background Field (ewfd)');
model.result('pg3').create('surf1', 'Surface');
model.result('pg3').feature('surf1').set('expr', 'sum(withsol(''sol1'',ewfd.Ebz,setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)');
...
model.result('pg5').label('Scattered Field (ewfd) 1');
model.result('pg5').create('surf1', 'Surface');
model.result('pg5').feature('surf1').set('expr', 'sum(withsol(''sol2'',ewfd.relEz,setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)');
...
model.result('pg6').label('Background Field (ewfd) 1');
model.result('pg6').create('surf1', 'Surface');
model.result('pg6').feature('surf1').set('expr', 'sum(withsol(''sol2'',ewfd.Ebz,setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)');
...
model.result('pg7').feature('surf1').set('expr', 'sum(withsol(''sol1'',ewfd.Ez,setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)');
...
model.result('pg7').feature('surf2').set('expr', 'sum(withsol(''sol1'',ewfd.Ez*exp(-j*modeNum*pi),setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)');
...
model.result('pg8').feature('surf1').set('expr', 'sum(withsol(''sol2'',ewfd.Ez,setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)');
...
model.result('pg8').feature('surf2').set('expr', 'sum(withsol(''sol2'',ewfd.Ez*exp(-j*modeNum*pi),setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)');
...
model.result('pg10').feature('slc1').set('expr', 'sum(withsol(''sol1'',ewfd.Ez*exp(-j*modeNum*rev1phi),setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)');
...
model.result('pg10').feature('surf1').set('expr', 'sum(withsol(''sol1'',ewfd.Ez*exp(-j*modeNum*rev1phi),setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)');
...
model.result('pg10').feature('slc3').set('expr', 'sum(withsol(''sol2'',ewfd.Ez*exp(-j*modeNum*rev2phi),setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)');
...
model.result('pg10').feature('slc4').set('expr', 'sum(withsol(''sol2'',ewfd.Ez*exp(-j*modeNum*rev2phi),setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)');
...
model.result('pg10').feature('surf2').set('expr', 'sum(withsol(''sol2'',ewfd.Ez*exp(-j*modeNum*rev2phi),setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)');
