function out = model
%
% loudspeaker_driver_geom_sequence.m
%
...
model.geom('geom1').feature('c1').set('r', '180[mm]');
...
model.geom('geom1').feature('r1').set('size', {'120[mm]' '1[mm]'});
...
model.geom('geom1').feature('fil1').selection('point').set('dif2', [5 6 7 8]);
model.geom('geom1').feature('fil1').set('radius', '0.2[mm]');
model.geom('geom1').run('fil1');
model.geom('geom1').create('r8', 'Rectangle');
model.geom('geom1').feature('r8').set('size', {'1.2 [mm]' '7.6[mm]'});
model.geom('geom1').feature('r8').set('pos', {'17.8[mm]' '-59.8[mm]'});
...
model.label('loudspeaker_driver_geom_sequence.mph');
