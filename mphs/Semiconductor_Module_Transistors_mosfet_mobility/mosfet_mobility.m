...
model.physics('semi').feature('smm1').create('mmar1', 'AroraMobilityModel', 2);
model.physics('semi').feature('smm1').create('mmls1', 'LombardiSurfaceMobilityModel', 2);
model.physics('semi').feature('smm1').feature('mmls1').set('mun_in_src', 'root.comp1.semi.mun_ar');
model.physics('semi').feature('smm1').feature('mmls1').set('mup_in_src', 'root.comp1.semi.mup_ar');
model.physics('semi').feature('smm1').create('mmct1', 'CaugheyThomasMobilityModel', 2);
model.physics('semi').feature('smm1').feature('mmct1').set('mun_in_src', 'root.comp1.semi.mun_ls');
model.physics('semi').feature('smm1').feature('mmct1').set('mup_in_src', 'root.comp1.semi.mup_ls');
...
model.study('std3').label('Study 3 - mobility models');
...
model.study('std3').feature('stat').setIndex('plistarr', '', 0);
model.study('std3').feature('stat').setIndex('punit', 'V', 0);
model.study('std3').feature('stat').setIndex('plistarr', 'range(0,0.1,0.5) 0.75 1 3 5', 0);
model.study('std3').feature('stat').setIndex('punit', 'V', 0);
...
model.sol('sol3').feature('s1').feature('se1').feature('ss1').set('segvar', {'comp1_V' 'comp1_Ne' 'comp1_Ph' 'comp1_semi_n_bnd' 'comp1_semi_p_bnd'});
...
model.sol('sol3').feature('s1').feature('se1').feature('ss2').set('segvar', {'comp1_semi_smm1_mmls1_Edn' 'comp1_semi_smm1_mmls1_Edp' 'comp1_semi_smm1_mmct1_Epn' 'comp1_semi_smm1_mmct1_Epp'});
...
model.result('pg9').label('Hole Concentration (semi) 1');
model.result('pg9').set('data', 'dset3');
model.result('pg9').setIndex('looplevel', 10, 0);
model.result('pg9').set('showlegendsmaxmin', true);
model.result('pg9').set('data', 'dset3');
model.result('pg9').setIndex('looplevel', 10, 0);
model.result('pg9').set('defaultPlotID', 'Semiconductor/phys3/pdef1/pcond2/pg2');
model.result('pg9').feature.create('surf1', 'Surface');
model.result('pg9').feature('surf1').set('showsolutionparams', 'on');
model.result('pg9').feature('surf1').set('expr', 'semi.P');
...
model.result('pg10').label('Electric Potential (semi) 1');
model.result('pg10').set('data', 'dset3');
model.result('pg10').setIndex('looplevel', 10, 0);
model.result('pg10').set('data', 'dset3');
model.result('pg10').setIndex('looplevel', 10, 0);
model.result('pg10').set('defaultPlotID', 'Semiconductor/phys3/pdef1/pcond2/pg3');
...
model.result('pg11').feature('surf2').set('expr', 'semi.Nnetdop');
model.result('pg11').feature('surf2').set('unit', '1/cm^3');
model.result('pg11').feature('surf2').set('coloring', 'gradient');
model.result('pg11').feature('surf2').set('colorscalemode', 'logarithmic');
model.result('pg11').feature('surf2').set('topcolor', 'red');
model.result('pg11').feature('surf2').set('bottomcolor', 'custom');
model.result('pg11').feature('surf2').set('custombottomcolor', [1 0.8 0.8]);
...
model.result('pg11').feature('surf2').feature.create('filt1', 'Filter');
model.result('pg11').feature('surf2').feature('filt1').set('expr', 'semi.Na-semi.Nd > 1[1/cm^3]');
model.result('pg11').feature('surf2').feature('filt1').set('useder', true);
model.result('pg11').feature('surf1').set('expr', 'semi.Nnetdop');
model.result('pg11').feature('surf1').set('unit', '1/cm^3');
model.result('pg11').feature('surf1').set('coloring', 'gradient');
model.result('pg11').feature('surf1').set('colorscalemode', 'logarithmic');
model.result('pg11').feature('surf1').set('topcolor', 'blue');
model.result('pg11').feature('surf1').set('bottomcolor', 'custom');
model.result('pg11').feature('surf1').set('custombottomcolor', [0.8 0.8 1]);
...
model.result('pg11').feature('surf1').feature.create('filt1', 'Filter');
model.result('pg11').feature('surf1').feature('filt1').set('expr', 'semi.Nd-semi.Na > 1[1/cm^3]');
model.result('pg11').feature('surf1').feature('filt1').set('useder', true);
model.result('pg11').set('titletype', 'manual');
model.result('pg11').set('title', 'Net Dopant Concentration \vert N<sub>d</sub> - N<sub>a</sub>\vert: P-type (Red), N-type (Blue)');
model.result('pg11').set('showlegendsmaxmin', true);
model.result('pg11').set('showlegendsunit', true);
model.result('pg11').set('legendpos', 'alternating');
model.result('pg11').feature('surf2').label('P-type');
model.result('pg11').feature('surf1').label('N-type');
model.result('pg11').label('Net Dopant Concentration (semi) 1');
...
model.result('pg12').run;
model.result('pg12').feature('glob2').set('data', 'dset3');
model.result('pg12').run;
model.result('pg12').feature('glob2').set('legendmethod', 'manual');
model.result('pg12').feature('glob2').setIndex('legends', 'Vg=2, mobility models', 0);
model.result('pg12').run;
model.result('pg12').feature('glob1').set('legendmethod', 'manual');
model.result('pg12').feature('glob1').setIndex('legends', 'Vg=2, constant mobility', 0);
model.result('pg12').run;

model.title('MOSFET with Mobility Models');

model.description('This tutorial shows how to add several linked mobility models to the basic MOSFET example, including two field-dependent mobility models which are very nonlinear and difficult to solve in a fully coupled manner. When such built-in field-dependent mobility models are used, the Semiconductor physics interface automatically creates a suggested solver sequence. Convergence is readily achieved by this autogenerated solver sequence which uses the Segregated solver to alternately solve the main dependent variables with the electric field variables fixed, and then update the electric field variables subsequently.');
...
model.label('mosfet_mobility.mph');
