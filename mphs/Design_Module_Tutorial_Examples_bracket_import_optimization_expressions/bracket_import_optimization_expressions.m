function out = model
%
% bracket_import_optimization_expressions.m
%
...
model.param.set('d_C_Cmp_Orig', 'LZ-dCmp/2-ZC-RCorig', 'Original distance between edges of central hole and component');
model.param.set('d_O_O_Orig', 'LY-2*YOOorig-2*ROorig', 'Original Distance between outer holes');
model.param.set('d_C_Cmp', 'd_C_Cmp_Orig-RCoff-ZCOdisp', 'Distance between edges of central hole and component');
model.param.set('d_O_O', 'd_O_O_Orig-2*(ROoff+YOOdisp)', 'Distance between outer holes');
model.param.set('d_O_Cmp', 'sqrt((YO-YOOdisp)^2+(LZ-ZO-ZOOdisp)^2)-RO-ZOOorig-ROoff', 'Distance between edges of outer hole and component');
model.param.set('d_O_C', 'sqrt((YO-YOOdisp)^2+(ZO-ZC-ZCOdisp+ZOOdisp)^2)-RO-RC-RCoff-ROoff', 'Distance between edges of outer and central holes');
...
model.geom('geom1').feature('wp1').label('Coordinate System - Central Hole');
model.geom('geom1').feature('wp1').set('planetype', 'circleperpendicular');
model.geom('geom1').feature('wp1').selection('circedge').set('imp1', 91);
model.geom('geom1').run('wp1');
model.geom('geom1').create('wp2', 'WorkPlane');
model.geom('geom1').feature('wp2').set('unite', true);
model.geom('geom1').feature('wp2').label('Coordinate System - Outer Hole 1');
model.geom('geom1').feature('wp2').set('planetype', 'circleperpendicular');
model.geom('geom1').feature('wp2').selection('circedge').set('imp1', 99);
...
model.geom('geom1').feature('wp3').label('Coordinate System - Outer Hole 2');
model.geom('geom1').feature('wp3').set('planetype', 'circleperpendicular');
model.geom('geom1').feature('wp3').selection('circedge').set('imp1', 81);
...
model.geom('geom1').feature('tf1').set('workplane', 'wp1');
model.geom('geom1').feature('tf1').set('factor', 'scaleRC');
model.geom('geom1').feature('tf1').set('displ', {'ZCOdisp' '0' '0'});
...
model.geom('geom1').feature('off1').set('distance', 'ROoff');
...
model.geom('geom1').feature('tf2').set('workplane', 'wp2');
model.geom('geom1').feature('tf2').set('displ', {'ZOOdisp' '0' 'YOOdisp'});
...
model.geom('geom1').feature('tf3').set('workplane', 'wp3');
model.geom('geom1').feature('tf3').set('displ', {'ZOOdisp' '0' 'YOOdisp'});
...
model.geom('geom1').feature('wp4').selection('offsetvertex').set('tf3', 18);
...
model.geom('geom1').feature('boxsel1').set('ymin', '7[mm]');
model.geom('geom1').feature('boxsel1').set('ymax', '22[mm]');
model.geom('geom1').feature('boxsel1').set('zmin', '13[mm]');
model.geom('geom1').feature('boxsel1').set('zmax', '22[mm]');
...
model.geom('geom1').feature('boxsel2').set('ymin', 'LY-22[mm]');
model.geom('geom1').feature('boxsel2').set('ymax', 'LY-7[mm]');
model.geom('geom1').feature('boxsel2').set('zmin', '13[mm]');
model.geom('geom1').feature('boxsel2').set('zmax', '22[mm]');
...
model.geom('geom1').feature('boxsel3').set('ymin', 'LY/2-8[mm]');
model.geom('geom1').feature('boxsel3').set('ymax', 'LY/2+8[mm]');
model.geom('geom1').feature('boxsel3').set('zmin', '0[mm]');
model.geom('geom1').feature('boxsel3').set('zmax', '12[mm]');
...
model.geom('geom1').feature('cyl1').set('r', 19);
model.geom('geom1').feature('cyl1').set('h', 100);
model.geom('geom1').feature('cyl1').set('pos', [10 36 70]);
...
model.param('default').paramCase('case2').set('RC', '0.0038307[m]');
model.param('default').paramCase('case2').set('ZCO', '0.0023049[m]');
model.param('default').paramCase('case2').set('YOO', '0.0070173[m]');
model.param('default').paramCase('case2').set('ZOO', '0.010863[m]');
model.param('default').paramCase('case2').set('RO', '0.011109[m]');
model.param('default').paramCase('case2').label('Optimum values');
model.param('default').setFromCase('case2');

model.geom('geom1').run('ige1');

model.title(['Optimization of an Imported Bracket Geometry ' native2unicode(hex2dec({'20' '14'}), 'unicode') ' with Parameter Expressions']);

model.description(['In this tutorial, you will use the Offset Faces and Transform Faces operations as a way to reparameterize existing holes in a bracket geometry imported from a STEP file. The mass of the bracket is minimized with limits for both the lowest natural frequency, and for the maximum stress in a static load case.' newline  newline 'Geometrical constraints, formulated as parameter expressions, are enforced during the optimization to maintain the design intent of the geometry.']);
