...
model.param.set('M', '(mu0_const*pi*R2^2)/(2*R1)');
...
model.geom('geom1').feature('c3').set('pos', {'R2' '0'});
...
model.physics('mf').feature('coil1').selection.set([5]);
model.physics('mf').feature('coil1').set('ICoil', 'I1');
model.physics('mf').create('coil2', 'Coil', 2);
model.physics('mf').feature('coil2').selection.set([4]);
...
model.result('pg1').label('Magnetic Flux Density DC');
model.result('pg1').create('str1', 'Streamline');
model.result('pg1').feature('str1').set('posmethod', 'start');
model.result('pg1').feature('str1').set('startmethod', 'coord');
model.result('pg1').feature('str1').set('xcoord', 'range(0,0.9*R1/29,0.9*R1)');
...
model.result.numerical('int1').setIndex('expr', 'mf.Bz/I1', 0);
...
model.result.numerical('int1').setIndex('expr', 'mf.Bz/I2', 0);
model.result.numerical('int1').set('table', 'tbl3');
...
model.result('pg2').label('Current Open Circuit');
model.result('pg2').set('data', 'dset3');
model.result('pg2').set('view', 'new');
model.result('pg2').create('surf1', 'Surface');
model.result('pg2').feature('surf1').set('expr', 'mf.Jphi');
model.result('pg2').feature('surf1').set('descr', 'Current density, phi-component');
model.result('pg2').run;
...
model.result.dataset('dset4').selection.geom('geom1', 2);
model.result.dataset('dset4').selection.set([4]);
model.result.create('pg3', 'PlotGroup2D');
model.result('pg3').run;
model.result('pg3').label('Current Closed Circuit');
...
model.title('Self-Inductance and Mutual Inductance Between Single Conductors');
...
model.label('mutual_inductance.mph');
