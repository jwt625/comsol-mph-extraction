function out = model
%
% ray_release_from_dipole_antenna_source_2daxi.m
%
...
model.param.descr('L0r', 'Ray direction, r-component');

model.geom('geom1').lengthUnit('mm');
model.geom('geom1').create('r1', 'Rectangle');
model.geom('geom1').feature('r1').set('size', [2.5 140]);
model.geom('geom1').feature('r1').set('pos', [0 -70]);
model.geom('geom1').run('r1');
model.geom('geom1').create('r2', 'Rectangle');
model.geom('geom1').feature('r2').set('size', [2.5 2]);
model.geom('geom1').feature('r2').set('pos', [0 -1]);
model.geom('geom1').run('r2');
model.geom('geom1').create('c1', 'Circle');
model.geom('geom1').feature('c1').set('r', 300);
model.geom('geom1').feature('c1').set('angle', 180);
model.geom('geom1').feature('c1').set('rot', -90);
model.geom('geom1').run('c1');
model.geom('geom1').create('c2', 'Circle');
model.geom('geom1').feature('c2').set('r', 2000);
model.geom('geom1').feature('c2').set('angle', 180);
model.geom('geom1').feature('c2').set('rot', -90);
model.geom('geom1').run('c2');
model.geom('geom1').create('dif1', 'Difference');
model.geom('geom1').feature('dif1').selection('input').set({'c1' 'c2'});
model.geom('geom1').feature('dif1').selection('input2').set({'r1' 'r2'});
model.geom('geom1').runPre('fin');
model.geom('geom1').run;

model.physics('emw').selection.set([2]);
model.physics('emw').create('lport1', 'LumpedPort', 1);
...
model.physics('emw').feature('sctr1').selection.set([11 12]);
model.physics('emw').create('ffd1', 'FarFieldDomain', 2);
model.physics('emw').feature('ffd1').feature('ffc1').selection.geom('geom1', 1);
model.physics('emw').feature('ffd1').feature('ffc1').selection.set([11 12]);
model.physics('emw2').create('lport1', 'LumpedPort', 1);
...
model.physics('emw2').create('sctr1', 'Scattering', 1);
model.physics('emw2').feature('sctr1').selection.set([10 13]);
...
model.sol('sol1').feature('s1').feature('d1').label('Suggested Direct Solver (emw) (Merged)');
...
model.title('Ray Release from a Dipole Antenna Source (2D Axisymmetric)');

model.description('In this tutorial model, the far-field radiation pattern of a dipole antenna is computed in a 2D axisymmetric model component. Then, in a separate 3D model component, a ray is released using the far-field radiation pattern to initialize the ray''s intensity, polarization, and phase.');
