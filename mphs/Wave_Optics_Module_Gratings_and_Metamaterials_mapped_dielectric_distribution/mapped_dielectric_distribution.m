...
model.physics('ewfd').feature('wee2').selection.named('sel1');
model.physics('ewfd').feature('wee2').set('DisplacementFieldModel', 'RelativePermittivity');
model.physics('ewfd').feature('wee2').set('epsilonr_mat', 'userdef');
model.physics('ewfd').feature('wee2').set('epsilonr', {'erp' '0' '0' '0' 'erp' '0' '0' '0' 'erp'});
model.physics('ewfd').feature('wee2').set('mur_mat', 'userdef');
model.physics('ewfd').feature('wee2').set('sigma_mat', 'userdef');
model.physics('ewfd').create('scu1', 'SurfaceCurrent', 1);
model.physics('ewfd').feature('scu1').selection.set([10]);
model.physics('ewfd').feature('scu1').set('Js0', {'0' '0' 'exp(-(y/w0)^2)'});
