function out = model
%
% electric_shielding_comparison.m
%
...
model.selection('sel2').label('Electric Shielding');
...
model.physics('ec').create('es1', 'ElectricShielding', 1);
model.physics('ec').feature('es1').selection.named('sel2');
...
model.sol('sol1').feature('s1').feature('p1').set('plistarr', {'1e-1 1e1 1e3'});
...
model.result('pg2').feature('arws1').set('expr', {'ec.Ex' 'ec.Ey'});
