...
model.study('std1').feature('param').setIndex('pname', 'epss_neg', 0);
...
model.study('std1').feature('param').setIndex('plistarr', '0.1 0.5 1 2 5 10', 0);
model.study('std1').feature('cdi').setEntry('activate', 'ge', false);
model.study('std1').feature('time').set('tlist', '0 1/C_rate');
...
model.sol('sol1').feature('v2').set('control', 'time');
model.sol('sol1').create('t1', 'Time');
model.sol('sol1').feature('t1').set('tlist', '0 1/C_rate');
model.sol('sol1').feature('t1').set('plot', 'off');
model.sol('sol1').feature('t1').set('plotgroup', 'Default');
model.sol('sol1').feature('t1').set('plotfreq', 'tout');
model.sol('sol1').feature('t1').set('probesel', 'all');
...
model.batch('p1').set('plistarr', {'0.1 0.5 1 2 5 10'});
...
model.sol('sol1').feature('t1').set('initialstepbdf', '0.001/C_rate');
...
model.result.numerical('gev1').set('descr', {'State variable W'});
model.result.create('pg7', 'PlotGroup1D');
model.result('pg7').set('data', 'dset3');
model.result('pg7').create('glob1', 'Global');
model.result('pg7').feature('glob1').set('expr', {'W'});
model.result('pg7').feature('glob1').set('descr', {'State variable W'});
model.result('pg2').run;
model.result.create('pg8', 'PlotGroup1D');
model.result('pg8').run;
model.result('pg8').label('Cell Voltages vs SOC');
model.result('pg8').set('data', 'dset3');
model.result('pg8').create('glob1', 'Global');
model.result('pg8').feature('glob1').set('markerpos', 'datapoints');
model.result('pg8').feature('glob1').set('linewidth', 'preference');
model.result('pg8').feature('glob1').set('expr', {'E_cell'});
model.result('pg8').feature('glob1').set('descr', {'Point Probe 1'});
model.result('pg8').feature('glob1').set('unit', {'V'});
model.result('pg8').feature('glob1').setIndex('descr', 'Cell voltage', 0);
model.result('pg8').feature('glob1').set('xdata', 'expr');
model.result('pg8').feature('glob1').set('xdataexpr', 'soc_cell');
model.result('pg8').feature('glob1').set('legendmethod', 'evaluated');
model.result('pg8').feature('glob1').set('legendpattern', 'eval(C_rate) C');
model.result('pg8').run;
...
model.result('pg8').feature('glob2').set('expr', {'E_ocv_cell'});
model.result('pg8').feature('glob2').set('descr', {'Open-circuit cell voltage'});
model.result('pg8').feature('glob2').set('unit', {'V'});
model.result('pg8').feature('glob2').set('data', 'dset3');
model.result('pg8').feature('glob2').setIndex('looplevelinput', 'first', 1);
model.result('pg8').feature('glob2').set('xdata', 'expr');
model.result('pg8').feature('glob2').set('xdataexpr', 'soc_cell');
model.result('pg8').feature('glob2').set('legendmethod', 'manual');
model.result('pg8').feature('glob2').setIndex('legends', 'OCV', 0);
model.result('pg8').feature('glob2').set('linestyle', 'dashed');
model.result('pg8').feature('glob2').set('linecolor', 'black');
model.result('pg8').run;
model.result('pg8').run;
model.result('pg8').set('titletype', 'none');
model.result('pg8').set('ylabelactive', true);
model.result('pg8').set('ylabel', 'Cell voltage (V)');
model.result('pg8').set('legendpos', 'upperleft');
model.result('pg8').run;
model.result.numerical.create('gev2', 'EvalGlobal');
model.result.numerical('gev1').label('Ragone Plot Data Evaluation');
model.result.numerical('gev1').setIndex('looplevelinput', 'last', 0);
model.result.numerical('gev1').setIndex('expr', 'W/(L_neg+L_sep+L_pos+L_ccs/2)', 0);
model.result.numerical('gev1').setIndex('unit', 'W*h/m^3', 0);
model.result.numerical('gev1').setIndex('descr', 'Volumetric Energy', 0);
model.result.numerical('gev1').setIndex('expr', 'W/t/(L_neg+L_sep+L_pos+L_ccs/2)', 1);
model.result.numerical('gev1').setIndex('descr', 'Average Volumetric Power', 1);
model.result.table.create('tbl2', 'Table');
model.result.table('tbl2').comments('Ragone Plot Data Evaluation');
model.result.numerical('gev1').set('table', 'tbl2');
model.result.numerical('gev1').setResult;
model.result.table('tbl2').label('Ragone Plot Data Energy Optimized Cell');
model.result.create('pg9', 'PlotGroup1D');
model.result('pg9').run;
model.result('pg9').label('Ragone Plots');
...
model.result('pg9').feature('tblp1').set('xaxisdata', 4);
model.result('pg9').feature('tblp1').set('plotcolumninput', 'manual');
model.result('pg9').feature('tblp1').set('plotcolumns', [3]);
model.result('pg9').feature('tblp1').set('legend', true);
model.result('pg9').feature('tblp1').set('legendmethod', 'manual');
model.result('pg9').feature('tblp1').setIndex('legends', 'Energy optimized', 0);
model.result('pg9').run;
...
model.sol('sol3').copySolution('sol10');
model.sol('sol10').label('Parametric Solutions - Energy Optimized Cell');
...
model.result.table('tbl3').comments('Ragone Plot Data Evaluation');
model.result.numerical('gev1').set('table', 'tbl3');
model.result.numerical('gev1').setResult;
model.result.table('tbl3').label('Ragone Plot Data for Power Optimized Cell');
model.result('pg9').run;
model.result('pg9').feature.duplicate('tblp2', 'tblp1');
model.result('pg9').run;
model.result('pg9').feature('tblp2').set('table', 'tbl3');
model.result('pg9').feature('tblp2').setIndex('legends', 'Power optimized', 0);
model.result('pg9').run;
model.result('pg6').run;
model.result('pg6').run;
model.result('pg4').run;
...
model.title('Lithium-Ion Battery Rate Capability');

model.description('This example demonstrates how a rate capability investigation of a specific battery design can be performed with the Lithium-Ion Battery interface. Energy and Power outputs are computed and analyzed.');
...
model.label('lib_rate_capability.mph');
