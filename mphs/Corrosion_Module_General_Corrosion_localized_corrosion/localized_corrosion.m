...
model.func('int1').set('filename', 'localized_corrosion_microstructure.txt');
...
model.variable('var1').set('beta_phase', 'intop1(micro(x,y))', 'Integral of beta phase');
model.variable('var1').set('alpha_phase', 'intop1(1-micro(x,y))', 'Integral of alpha phase');
model.variable('var1').set('i_alpha_phase', 'intop1((i_alpha(-phil))*(1-micro(x,y)))', 'Integral of alpha phase current');
model.variable('var1').set('beta_phase_fraction', 'beta_phase/(beta_phase+alpha_phase)', 'Beta phase fraction');
...
model.physics('cd').feature('es1').feature('er1').set('nm', 'z_charge');
...
model.physics('cd').feature('es1').feature('er1').set('ilocmat', '(i_alpha(-phil))*(1-micro(x,y))');
model.physics('cd').feature('es1').create('er2', 'ElectrodeReaction', 1);
model.physics('cd').feature('es1').feature('er2').set('ilocmat_mat', 'userdef');
model.physics('cd').feature('es1').feature('er2').set('ilocmat', '(i_beta(-phil))*micro(x,y)');
...
model.study('std1').feature('time').set('tlist', 'range(0,1,24*3)');
...
model.sol('sol1').feature('v1').feature('comp1_material_disp').set('scaleval', '2.4984395129760495E-6');
...
model.sol('sol1').feature('v2').feature('comp1_material_disp').set('scaleval', '2.4984395129760495E-6');
...
model.sol('sol1').feature('t1').set('tlist', 'range(0,1,24*3)');
...
model.sol('sol1').feature('t1').feature('st1').setIndex('stopcondActive', true, 0);
model.sol('sol1').feature('t1').feature('st1').setIndex('stopconddesc', 'Stop expression 1', 0);
model.sol('sol1').feature('t1').feature('st1').setIndex('stopcondarr', 'comp1.beta_phase_fraction>0.95', 0);
...
model.result('pg6').set('title', 'Change in surface beta phase fraction with time');
model.result('pg6').set('ylabelactive', true);
model.result('pg6').set('ylabel', 'Surface beta phase fraction');
model.result('pg6').create('glob1', 'Global');
model.result('pg6').feature('glob1').set('markerpos', 'datapoints');
model.result('pg6').feature('glob1').set('linewidth', 'preference');
model.result('pg6').feature('glob1').setIndex('expr', 'beta_phase_fraction', 0);
...
model.result('pg6').run;
model.result('pg6').label('1D Plot Group : Surface beta phase fraction evolution');
model.result.duplicate('pg7', 'pg6');
model.result('pg7').run;
model.result('pg7').set('title', 'Change in average anode current density with time');
model.result('pg7').set('ylabel', 'Average anode current density (A/m<sup>2</sup>)');
model.result('pg7').run;
model.result('pg7').feature('glob1').setIndex('expr', 'i_alpha_phase/alpha_phase', 0);
model.result('pg7').feature('glob1').setIndex('unit', 1, 0);
model.result('pg7').feature('glob1').setIndex('descr', '', 0);
model.result('pg7').run;
model.result('pg7').label('1D Plot Group : Average anode current density evolution');

model.title('Localized Corrosion');

model.description('This example models galvanic corrosion between two different phases in a magnesium alloy for a representative cross-sectional microstructure configuration. A key feature in the model formulation is the implementation of both anodic and cathodic regions at the electrode surface, using a single boundary represented in terms of a level set function.');
...
model.label('localized_corrosion.mph');
