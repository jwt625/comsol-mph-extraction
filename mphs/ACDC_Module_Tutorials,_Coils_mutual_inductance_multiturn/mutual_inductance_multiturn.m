...
model.param.descr('N', 'Number of turns in secondary');
model.param.set('M', 'N*(mu0_const*pi*R2^2)/(2*R1)');
model.param.descr('M', 'Analytic mutual inductance in secondary');
...
model.physics('mf').feature('coil2').set('N', 'N');
model.physics('mf').feature('coil2').set('coilWindArea', 'pi*r_wire^2');
...
model.title('Self-Inductance and Mutual Inductance of a Single Conductor and a Homogenized Helical Coil');
