...
model.geom('geom1').feature('r2').set('size', {'w' '1[um]'});
model.geom('geom1').feature('r2').set('pos', {'0' 'th-1[um]'});
...
model.physics('semi').feature('mc1').set('Phi', 'phim');
...
model.mesh('mesh1').feature('map1').feature('dis2').set('elemratio', 100);
...
model.result('pg1').set('defaultPlotID', 'Semiconductor/phys3/pdef1/pcond4/pg1');
...
model.result('pg2').set('defaultPlotID', 'Semiconductor/phys3/pdef1/pcond4/pg2');
...
model.result('pg3').set('defaultPlotID', 'Semiconductor/phys3/pdef1/pcond4/pg3');
...
model.result('pg4').label('Electron Concentration (semi) 1');
model.result('pg4').set('showlegendsmaxmin', true);
model.result('pg4').set('data', 'rev1');
model.result('pg4').setIndex('looplevel', 25, 0);
model.result('pg4').set('defaultPlotID', 'Semiconductor/phys3/pdef1/pcond4/pg4');
...
model.result('pg5').label('Hole Concentration (semi) 1');
model.result('pg5').set('showlegendsmaxmin', true);
model.result('pg5').set('data', 'rev1');
model.result('pg5').setIndex('looplevel', 25, 0);
model.result('pg5').set('defaultPlotID', 'Semiconductor/phys3/pdef1/pcond4/pg5');
...
model.result('pg6').label('Electric Potential (semi) 1');
model.result('pg6').set('data', 'rev1');
model.result('pg6').setIndex('looplevel', 25, 0);
model.result('pg6').set('defaultPlotID', 'Semiconductor/phys3/pdef1/pcond4/pg6');
...
model.result('pg7').feature('surf2').set('custombottomcolor', [1 0.8 0.8]);
...
model.result('pg7').feature('surf1').set('custombottomcolor', [0.8 0.8 1]);
...
model.result('pg7').set('title', 'Net Dopant Concentration \vert N<sub>d</sub> - N<sub>a</sub>\vert: P-type (Red), N-type (Blue)');
model.result('pg7').set('showlegendsmaxmin', true);
model.result('pg7').set('showlegendsunit', true);
model.result('pg7').set('legendpos', 'alternating');
model.result('pg7').feature('surf2').label('P-type');
model.result('pg7').feature('surf1').label('N-type');
model.result('pg7').label('Net Dopant Concentration (semi)');
...
model.result('pg7').feature('tblp1').setIndex('legends', 'Reference', 0);
...
model.result('pg7').feature('glob1').setIndex('legends', 'Model', 0);
model.result('pg7').run;
model.result('pg6').run;

model.title('Schottky Contact');

model.description('This benchmark simulates the behavior of an ideal Schottky barrier diode made of a tungsten contact deposited on a silicon wafer. The resulting J-V (current density vs. applied voltage) curve obtained from the model under forward bias is compared with experimental measurements found in the literature.');
