function out = model
%
% lib_diffusion_induced_stress.m
%
...
model.variable('var1').set('I_app', '(-I_1C*4)*step1((t-750)[1/s])');
...
model.physics('liion').feature('pce1').feature('pin1').set('StressStrain', true);
model.physics('liion').feature('pce1').feature('pin1').set('E', 'E');
model.physics('liion').feature('pce1').feature('pin1').set('fvol', 'fvol(liion.cs_pce1/liion.csmax)');
model.physics('liion').feature('pce1').feature('pin1').set('Distribution', 'Linear');
model.physics('liion').feature('pce1').feature('pin1').set('Nel', 30);
...
model.sol('sol1').feature('v2').set('control', 'time');
model.sol('sol1').create('t1', 'Time');
model.sol('sol1').feature('t1').set('tlist', 'range(0,10,1100)');
model.sol('sol1').feature('t1').set('plot', 'off');
model.sol('sol1').feature('t1').set('plotgroup', 'Default');
model.sol('sol1').feature('t1').set('plotfreq', 'tout');
model.sol('sol1').feature('t1').set('probesel', 'all');
...
model.result('pg6').set('title', 'Diffusion-induced surface strain, radial component');
...
model.result('pg7').set('title', 'Diffusion-induced surface strain, tangential component');
model.result('pg7').run;
...
model.result('pg9').label('Surface von Mises stress versus time');
...
model.result('pg9').feature('glob1').set('expr', {'I_app'});
model.result('pg9').feature('glob1').set('descr', {'Applied cell current density'});
model.result('pg9').feature('glob1').set('unit', {'A/m^2'});
model.result('pg9').run;
model.result('pg9').set('twoyaxes', true);
model.result('pg9').setIndex('plotonsecyaxis', true, 1, 1);
model.result('pg9').set('titletype', 'manual');
model.result('pg9').set('title', 'Surface von Mises stress and Applied current');
...
model.label('lib_diffusion_induced_stress.mph');
