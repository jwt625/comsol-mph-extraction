...
model.modelPath('/Applications/COMSOL62/Multiphysics/applications/Pipe_Flow_Module/Applications');
...
model.param.descr('t_step', 'Interval between time steps');
model.param.set('t_end', '2[d]');
model.param.descr('t_end', 'Simulation end time');
model.param.set('T_min', '-5[degC]');
model.param.descr('T_min', 'Minimum allowed temperature for pipe fluid');

model.mesh.create('mesh2', 'geom1');
model.mesh('mesh2').create('edg1', 'Edge');
model.mesh('mesh2').feature('edg1').selection.named('geom1_csel1_edg');
model.mesh('mesh2').feature('edg1').create('size1', 'Size');
model.mesh('mesh2').feature('edg1').feature('size1').selection.geom('geom1', 0);
model.mesh('mesh2').feature('edg1').feature('size1').selection.set([7 11]);
model.mesh('mesh2').feature('edg1').feature('size1').set('hauto', 1);
model.mesh('mesh2').feature('edg1').feature('size1').set('custom', true);
model.mesh('mesh2').feature('edg1').feature('size1').set('hmaxactive', true);
model.mesh('mesh2').feature('edg1').feature('size1').set('hmax', 0.5);
model.mesh('mesh2').feature('edg1').create('size2', 'Size');
model.mesh('mesh2').feature('edg1').feature('size2').set('hauto', 2);
model.mesh('mesh2').feature('edg1').feature('size2').set('custom', true);
model.mesh('mesh2').feature('edg1').feature('size2').set('hmaxactive', true);
model.mesh('mesh2').feature('edg1').feature('size2').set('hmax', 0.7);
model.mesh('mesh2').feature('edg1').feature('size2').set('hminactive', true);
model.mesh('mesh2').feature('edg1').feature('size2').set('hmin', 0.03);
model.mesh('mesh2').create('ftet1', 'FreeTet');
model.mesh('mesh2').run;
model.mesh.create('mesh3', 'geom1');
model.mesh('mesh3').create('edg1', 'Edge');
model.mesh('mesh3').feature('edg1').selection.named('geom1_csel1_edg');
model.mesh('mesh3').feature('edg1').create('size1', 'Size');
model.mesh('mesh3').feature('edg1').feature('size1').selection.geom('geom1', 0);
model.mesh('mesh3').feature('edg1').feature('size1').selection.set([7 11]);
model.mesh('mesh3').feature('edg1').feature('size1').set('hauto', 1);
model.mesh('mesh3').feature('edg1').feature('size1').set('custom', true);
model.mesh('mesh3').feature('edg1').feature('size1').set('hmaxactive', true);
model.mesh('mesh3').feature('edg1').feature('size1').set('hmax', 0.1);
model.mesh('mesh3').feature('edg1').create('size2', 'Size');
model.mesh('mesh3').feature('edg1').feature('size2').set('hauto', 2);
model.mesh('mesh3').feature('edg1').feature('size2').set('custom', true);
model.mesh('mesh3').feature('edg1').feature('size2').set('hmaxactive', true);
model.mesh('mesh3').feature('edg1').feature('size2').set('hmax', 0.3);
model.mesh('mesh3').feature('edg1').feature('size2').set('hminactive', true);
model.mesh('mesh3').feature('edg1').feature('size2').set('hmin', 0.01);
model.mesh('mesh3').create('ftet1', 'FreeTet');
model.mesh('mesh3').feature('size').set('hauto', 3);
...
model.result.numerical('min1').label('Minimum Temperature');
model.result.numerical('min1').selection.named('geom1_csel1_edg');
model.result.numerical('min1').set('expr', {'T2'});
...
model.result.table('tbl4').comments('Minimum Temperature');
...
model.result.numerical('gev5').label('Daily Heat Demand');
...
model.result.numerical('gev5').remove('expr', [1]);
model.result.table.create('tbl5', 'Table');
model.result.table('tbl5').comments('Daily Heat Demand');
...
model.title('Heat Recovery System for a Geothermal Heat Pump');

model.description(['This app demonstrates the following:' newline  newline  native2unicode(hex2dec({'20' '22'}), 'unicode') ' Changing the design by using a combo box with predefined options' newline  native2unicode(hex2dec({'20' '22'}), 'unicode') ' Options for creating different mesh sizes' newline  native2unicode(hex2dec({'20' '22'}), 'unicode') ' Editing and plotting monthly data input' newline  native2unicode(hex2dec({'20' '22'}), 'unicode') ' Setting the end time and the time steps size of a time dependent simulation' newline  native2unicode(hex2dec({'20' '22'}), 'unicode') ' Visualizing the initial values for a time dependent simulation' newline  native2unicode(hex2dec({'20' '22'}), 'unicode') ' Includes a simple control system to manage the temperature' newline  newline 'Geothermal heating is an environmentally friendly and energy-efficient method to supply modern and well insulated houses with heat. Heat exchangers placed at a sufficient depth in the ground below the house utilize subsurface heat, where temperatures are almost constant throughout the year.' newline  newline 'The app studies different pipe configurations of a ground heat exchanger. It provides information on the performance of ground-coupled heat exchangers for different specifications (depth, pattern, pipes configuration, and heating conditions), temperature conditions, soil thermal conductivity, and temperature gradient.' newline  newline 'The heater can also be turned off if the daily heat demand is achieved, and then turned on again after 24' native2unicode(hex2dec({'00' 'a0'}), 'unicode') 'hours. The temperature at the pipe''s outlet can be controlled and compared to the minimum temperature required in the heat exchanger specifications.']);
...
model.result.report('rpt1').feature('sec4').feature('pg1').set('customcaption', 'Temperature');
model.result.report('rpt1').feature('sec4').feature.create('pg2', 'PlotGroup');
model.result.report('rpt1').feature('sec4').feature('pg2').label('Outlet Temperature');
...
model.result.report('rpt1').feature('sec4').feature('pg2').set('customcaption', 'Outlet temperature');
model.result.report('rpt1').feature('sec4').feature.create('mtbl1', 'Table');
model.result.report('rpt1').feature('sec4').feature('mtbl1').label('Minimum Temperature');
...
model.result.report('rpt1').feature('sec4').feature('pg3').label('Heat Production');
...
model.result.report('rpt1').feature('sec4').feature('pg3').set('customcaption', 'Heat production');
model.result.report('rpt1').feature('sec4').feature.create('pg4', 'PlotGroup');
model.result.report('rpt1').feature('sec4').feature('pg4').label('Heater State');
...
model.result.report('rpt1').feature('sec4').feature('pg4').set('customcaption', 'Heater state');
model.result('pg7').run;
