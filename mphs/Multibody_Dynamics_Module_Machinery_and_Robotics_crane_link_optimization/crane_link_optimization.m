...
model.param.set('XC', '-0.150[m]', 'X position of base center');
model.param.set('YL1', '-0.950[m]', 'Original Y-coordinate of Link1 axis in Base');
model.param.set('ZL1', '1.875[m]', 'Original Z-coordinate of Link1 axis in Base');
model.param.set('YL2', '-0.419[m]', 'Original Y-coordinate of Link2 axis in Boom1');
model.param.set('ZL2', '1.945[m]', 'Original Z-coordinate of Link2 axis in Boom1');
model.param.set('YPE', '-0.471[m]', 'Original Y-coordinate of Piston1 end');
model.param.set('ZPE', '1.832[m]', 'Original Z-coordinate of Piston1 end');
model.param.set('YCE', '-0.385[m]', 'Y-coordinate of Cylinder1 end');
model.param.set('ZCE', '0.550[m]', 'Z-coordinate of Cylinder1 end');
model.param.set('dYL1', '0[m]', 'Change in Y-coordinate of Link1 axis in Base');
model.param.set('dZL1', '0[m]', 'Change in Z-coordinate of Link1 axis in Base');
model.param.set('dYL2', '0[m]', 'Change in Y-coordinate of Link2 axis in Boom1');
model.param.set('dZL2', '0[m]', 'Change in Z-coordinate of Link2 axis in Boom1');
model.param.set('dYPE', '0[m]', 'Change in Y-coordinate of Piston1 end');
model.param.set('dZPE', '0[m]', 'Change in Y-coordinate of Piston1 end');
model.param.set('mYL1', 'YL1+dYL1', 'Modified Y-coordinate of Link1 axis in Base');
model.param.set('mZL1', 'ZL1+dZL1', 'Modified Z-coordinate of Link1 axis in Base');
model.param.set('mYL2', 'YL2+dYL2', 'Modified Y-coordinate of Link2 axis in Boom1');
model.param.set('mZL2', 'ZL2+dZL2', 'Modified Z-coordinate of Link2 axis in Boom1');
model.param.set('mYPE', 'YPE+dYPE', 'Modified Y-coordinate of Piston1 end');
model.param.set('mZPE', 'ZPE+dZPE', 'Modified Z-coordinate of Piston1 end');
model.param.set('lCyl', 'sqrt((YPE-YCE)^2+(ZPE-ZCE)^2)', 'Original length between ends of Cylinder1+Piston1');
model.param.set('mlCyl', 'sqrt((mYPE-YCE)^2+(mZPE-ZCE)^2)', 'Modified length between ends of Cylinder1+Piston1');
model.param.set('cylRot', 'asin(((YPE-YCE)*(mZPE-ZCE)-(ZPE-ZCE)*(mYPE-YCE))/(lCyl*mlCyl))', 'Change in slope of Cylinder1+Piston1');
model.param.set('dL2PE', 'sqrt((YPE-YL2)^2+(ZPE-ZL2)^2)', 'Original distance between the two ends of Link2');
model.param.set('mdL2PE', 'sqrt((mYPE-mYL2)^2+(mZPE-mZL2)^2)', 'Modified distance between the two ends of Link2');

model.geom('geom1').run('imp1');
model.geom('geom1').create('rot1', 'Rotate');
model.geom('geom1').feature('rot1').selection('input').set({'imp1(31)' 'imp1(32)'});
model.geom('geom1').feature('rot1').set('pos', {'0' 'YCE' 'ZCE'});
model.geom('geom1').feature('rot1').set('rot', 'cylRot');
model.geom('geom1').feature('rot1').set('axistype', 'x');
model.geom('geom1').run;

model.physics('mbd').feature('hgj3').set('CenterOfJointType', 'UserDefined');
model.physics('mbd').feature('hgj3').set('xc', {'XC' 'mYL1' 'mZL1'});
model.physics('mbd').feature('hgj4').set('CenterOfJointType', 'UserDefined');
model.physics('mbd').feature('hgj4').set('xc', {'XC' 'mYL2' 'mZL2'});
model.physics('mbd').feature('slj1').set('CenterOfJointType', 'UserDefined');
model.physics('mbd').feature('slj1').set('xc', {'XC' 'mYPE' 'mZPE'});
model.physics('mbd').feature('slj2').set('CenterOfJointType', 'UserDefined');
model.physics('mbd').feature('slj2').set('xc', {'XC' 'mYPE' 'mZPE'});

model.param.set('ExtLen', '5.5[m]');

model.study('std1').feature('stat').setIndex('plistarr', 'range(-45,15,90)', 0);
model.study('std1').feature('stat').setIndex('plistarr', '0 0 0 range(0,-15,-90)', 1);
model.study('std1').feature('stat').remove('pname', 2);
model.study('std1').feature('stat').remove('punit', 2);
model.study('std1').feature('stat').remove('plistarr', [2]);
...
model.result('pg2').feature('glob1').setIndex('expr', 'abs(comp1.mbd.prj1.Fl1)', 0);
model.result('pg2').feature('glob1').setIndex('descr', 'Optimized', 0);
model.result('pg2').feature.duplicate('glob2', 'glob1');
model.result('pg2').run;
model.result('pg2').feature('glob2').set('data', 'dset2');
model.result('pg2').feature('glob2').setIndex('descr', 'Original', 0);
model.result('pg3').run;
...
model.result('pg4').feature('glob1').remove('descr', 2);
model.result('pg4').feature('glob1').remove('expr', [2]);
model.result('pg4').feature('glob1').setIndex('descr', 'Optimized force, y', 0);
model.result('pg4').feature('glob1').setIndex('descr', 'Optimized force, z', 1);
model.result('pg4').feature('glob1').setIndex('expr', 'sqrt(mbd.hgj1.Fy^2+mbd.hgj1.Fz^2)', 2);
model.result('pg4').feature('glob1').setIndex('unit', 'kN', 2);
model.result('pg4').feature('glob1').setIndex('descr', 'Optimized total force', 2);
model.result('pg4').feature.duplicate('glob2', 'glob1');
model.result('pg4').run;
model.result('pg4').feature('glob2').set('data', 'dset2');
model.result('pg4').feature('glob2').setIndex('descr', 'Original force, y', 0);
model.result('pg4').feature('glob2').setIndex('descr', 'Original force, z', 1);
model.result('pg4').feature('glob2').setIndex('descr', 'Original total force', 2);

model.study('std1').create('opt', 'Optimization');
model.study('std1').feature('opt').set('optsolver', 'bobyqa');
model.study('std1').feature('opt').set('opttol', 0.1);
model.study('std1').feature('opt').setIndex('optobj', 'abs(comp1.mbd.prj1.Fl1)', 0);
model.study('std1').feature('opt').setIndex('descr', 'Cylinder force (inner)', 0);
model.study('std1').feature('opt').set('objectivesolution', 'max');
model.study('std1').feature('opt').set('pname', {'dYL1' 'dZL1' 'dYL2' 'dZL2' 'dYPE' 'dZPE'});
model.study('std1').feature('opt').set('initval', {'0[m]' '0[m]' '0[m]' '0[m]' '0[m]' '0[m]'});
model.study('std1').feature('opt').set('scale', {'0.1' '0.15' '0.05' '0.1' '0.12' '0.1'});
model.study('std1').feature('opt').set('lbound', {'-0.10[m]' '-0.15[m]' '-0.05[m]' '-0.05[m]' '-0.05[m]' '-0.10[m]'});
model.study('std1').feature('opt').set('ubound', {'0.05[m]' '0.03[m]' '0.05[m]' '0.10[m]' '0.12[m]' '0.02[m]'});
model.study('std1').feature('opt').setIndex('constraintExpression', 'mdL2PE-dL2PE', 0);
model.study('std1').feature('opt').setIndex('constraintLbound', -0.01, 0);
model.study('std1').feature('opt').set('plot', true);
model.study('std1').feature('opt').set('plotgroup', 'pg2');
...
model.result('pg6').label('Displacement (mbd) 1');
...
model.title('Optimization of a Crane Link Mechanism');

model.description('In this example, the geometry of a link mechanism is optimized. The purpose is to reduce the required force in a hydraulic cylinder when lifting a given load to a number of crane positions.');
...
model.label('crane_link_optimization.mph');
