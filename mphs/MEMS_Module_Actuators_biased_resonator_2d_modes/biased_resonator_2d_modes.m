...
model.sol('sol2').feature('e1').set('eigvfunscaleparam', '4.51E-11');
...
model.result('pg4').label('Unbiased Modes');
...
model.sol('sol3').feature('v1').feature('comp1_spatial_disp').set('scaleval', '1e-2*4.505367246129886E-5');
model.sol('sol3').feature('v1').feature('comp1_u').set('scaleval', '1e-2*4.505367246129886E-5');
...
model.sol('sol3').feature('v2').feature('comp1_spatial_disp').set('scaleval', '1e-2*4.505367246129886E-5');
model.sol('sol3').feature('v2').feature('comp1_u').set('scaleval', '1e-2*4.505367246129886E-5');
...
model.sol('sol3').feature('e1').set('eigvfunscaleparam', '4.51E-11');
...
model.result('pg5').label('Biased Modes');
...
model.result('pg6').feature('ptgr1').set('prefixintitle', 'Eigenfrequency vs. DC Voltage');
model.result('pg6').feature('ptgr1').set('linestyle', 'none');
model.result('pg6').feature('ptgr1').set('linemarker', 'square');
model.result('pg6').run;

model.title(['Normal Modes of a Biased Resonator ' native2unicode(hex2dec({'20' '14'}), 'unicode') ' 2D']);
