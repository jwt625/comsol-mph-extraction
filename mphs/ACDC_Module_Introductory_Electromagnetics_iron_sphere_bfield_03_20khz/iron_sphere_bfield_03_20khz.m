...
model.physics('mf').feature('fsp1').set('sigma_stab', [50 0 0 0 50 0 0 0 50]);

model.mesh('mesh1').run;

model.study('std1').feature('freq').set('plist', '20[kHz]');
...
model.sol('sol1').feature('s1').feature('p1').set('plistarr', {'20[kHz]'});
...
model.mesh('mesh1').feature('bl1').feature('blp').set('blhmin', '8[um]');
...
model.result('pg2').label('Mesh Plot 2');
model.result('pg2').set('data', 'mesh1');
model.result('pg2').set('inherithide', true);
...
model.result('pg2').feature('mesh1').set('titletype', 'none');
model.result('pg2').feature('mesh1').set('elemtype3', 'prism');
model.result('pg2').feature('mesh1').set('elemcolor', 'cyan');
model.result('pg2').feature('mesh1').set('filteractive', true);
model.result('pg2').feature('mesh1').set('logfilterexpr', 'z<0');
model.result('pg2').feature.duplicate('mesh2', 'mesh1');
model.result('pg2').run;
model.result('pg2').feature('mesh2').set('elemtype3', 'tet');
model.result('pg2').feature('mesh2').set('elemcolor', 'yellow');
model.result('pg2').run;
...
model.result('pg1').feature('arwv1').set('ynumber', 30);
...
model.result('pg1').feature('arwv1').set('scale', '3e-7');
model.result('pg1').run;
...
model.result('pg3').feature('slc1').set('expr', 'mf.normJ');
model.result('pg3').feature('slc1').set('descr', 'Current density norm');
model.result('pg3').feature('slc1').set('quickxnumber', 1);
model.result('pg3').feature('slc1').set('colortable', 'Thermal');
model.result('pg3').feature('slc1').set('colortabletrans', 'reverse');
model.result('pg3').feature('slc1').create('sel1', 'Selection');
model.result('pg3').feature('slc1').feature('sel1').selection.named('sel1');
model.result('pg3').run;
model.result('pg3').create('surf1', 'Surface');
model.result('pg3').feature('surf1').set('expr', 'material.boundary');
model.result('pg3').feature('surf1').set('descr', 'Material settings');
...
model.result('pg3').feature('surf1').feature('mtrl1').set('family', 'ironscratched');
model.result('pg3').run;
model.result('pg3').feature('surf1').create('filt1', 'Filter');
model.result('pg3').run;
model.result('pg3').feature('surf1').feature('filt1').set('expr', 'x>0');
model.result('pg3').run;
...
model.result('pg3').feature('mslc1').set('xcoord', '');
model.result('pg3').feature('mslc1').set('ycoord', '');
model.result('pg3').feature('mslc1').create('tran1', 'Transparency');
model.result('pg3').run;
model.result('pg3').feature('mslc1').feature('tran1').set('transparency', 0.15);
model.result('pg3').run;
model.result('pg3').run;
model.result('pg3').feature('strmsl1').set('xcoord', '');
model.result('pg3').feature('strmsl1').set('ycoord', '');
model.result('pg3').run;

model.title(['Iron Sphere in a Magnetic Field ' native2unicode(hex2dec({'20' '14'}), 'unicode') ' 20' native2unicode(hex2dec({'00' 'a0'}), 'unicode') 'kHz']);

model.description('An iron sphere is exposed to a spatially uniform background magnetic field that is sinusoidally time-varying at a frequency of 20 kHz. The frequency of the field is such that the skin depth is smaller than the sphere radius. The example computes the induced currents in the sphere and the perturbation to the background field. In addition, it addresses the question of how to properly mesh domains with significant skin effect.');

model.mesh.clearMeshes;

model.sol('sol1').clearSolutionData;

model.label('iron_sphere_bfield_03_20khz.mph');
