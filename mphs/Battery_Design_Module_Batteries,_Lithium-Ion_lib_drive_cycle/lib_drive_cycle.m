...
model.func('int1').set('filename', 'lib_drive_cycle_data.txt');
model.func('int1').importData;
model.func('int1').setIndex('funcs', 'load_function', 0, 0);
model.func('int1').setIndex('argunit', 's', 0);

model.physics('liion').feature('ecd1').set('nis', 'I_1C*load_function(t)');
...
model.result('pg7').label('Cell Voltage and Load');
model.result('pg7').create('glob1', 'Global');
model.result('pg7').feature('glob1').set('markerpos', 'datapoints');
model.result('pg7').feature('glob1').set('linewidth', 'preference');
model.result('pg7').feature('glob1').set('expr', {'E_cell'});
model.result('pg7').feature('glob1').set('descr', {'Point Probe 1'});
model.result('pg7').feature('glob1').set('unit', {'V'});
model.result('pg7').feature('glob1').setIndex('descr', 'Cell voltage', 0);
model.result('pg7').feature('glob1').set('expr', {'E_cell' 'E_ocv_cell'});
model.result('pg7').feature('glob1').set('descr', {'Cell voltage' 'Open-circuit cell voltage'});
...
model.result('pg7').feature('glob2').setIndex('expr', 'load_function(t)', 0);
model.result('pg7').feature('glob2').setIndex('descr', 'Current', 0);
model.result('pg7').feature('glob2').set('linecolor', 'red');
model.result('pg7').feature('glob2').set('legendmethod', 'manual');
model.result('pg7').feature('glob2').setIndex('legends', 'I<sub>cell</sub>', 0);
model.result('pg7').run;
...
model.result('pg7').set('yseclabel', 'Current (C-rate)');
model.result('pg7').setIndex('plotonsecyaxis', true, 1, 1);
model.result('pg7').run;
model.result.duplicate('pg8', 'pg7');
model.result('pg8').run;
model.result('pg8').label('Total Polarization and Load');
model.result('pg8').set('ylabel', 'Polarization Voltage (V)');
model.result('pg8').run;
model.result('pg8').feature('glob1').set('expr', {'E_pol_tot'});
model.result('pg8').feature('glob1').set('descr', {'Total battery cell polarization'});
model.result('pg8').feature('glob1').set('unit', {'V'});
model.result('pg8').feature('glob1').setIndex('legends', 'E <sub>pol</sub>', 0);
model.result('pg8').run;
model.result.create('pg9', 'PlotGroup1D');
model.result('pg9').run;
model.result('pg9').label('SOC and Lithiation Levels');
model.result('pg9').create('glob1', 'Global');
model.result('pg9').feature('glob1').set('markerpos', 'datapoints');
model.result('pg9').feature('glob1').set('linewidth', 'preference');
model.result('pg9').feature('glob1').set('expr', {'soc_cell'});
model.result('pg9').feature('glob1').set('descr', {'Battery cell state of charge'});
model.result('pg9').feature('glob1').set('unit', {'1'});
model.result('pg9').feature('glob1').set('expr', {'soc_cell' 'sol_pos'});
model.result('pg9').feature('glob1').set('descr', {'Battery cell state of charge' 'Degree of lithiation, positive'});
model.result('pg9').feature('glob1').set('expr', {'soc_cell' 'sol_pos' 'sol_neg'});
model.result('pg9').feature('glob1').set('descr', {'Battery cell state of charge' 'Degree of lithiation, positive' 'Degree of lithiation, negative'});
model.result('pg9').run;
...
model.result('pg9').set('title', 'State of charge and average lithiation levels');
model.result('pg9').set('ylabelactive', true);
model.result('pg9').set('ylabel', 'SOC or SOL (1)');
model.result('pg9').run;
model.result.create('pg10', 'PlotGroup1D');
model.result('pg10').run;
model.result('pg10').label('Positive Electrode Potentials');
...
model.result('pg10').set('ylabel', 'Electrode Potential vs Li/Li<sup>+</sup>');
model.result('pg10').set('yseclabelactive', true);
model.result('pg10').set('yseclabel', 'Current (C-rate)');
model.result('pg10').run;
model.result('pg10').set('titletype', 'manual');
model.result('pg10').set('title', 'Positive Electrode Potentials');
model.result('pg10').set('legendpos', 'lowerleft');
model.result('pg10').run;
model.result.duplicate('pg11', 'pg10');
model.result('pg11').run;
model.result('pg11').label('Negative Electrode Potentials');
model.result('pg11').set('title', 'Negative Electrode Potentials');
model.result('pg11').run;
