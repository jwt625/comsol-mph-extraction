...
model.physics('mf').create('ge1', 'GlobalEquations', -1);
model.physics('mf').feature('ge1').setIndex('name', 'vv', 0, 0);
model.physics('mf').feature('ge1').setIndex('equation', 'vvt-if(at_bottom,0,min(mf.Forcez_0+k0*(x0-disp),0)/mass)', 0, 0);
model.physics('mf').feature('ge1').setIndex('description', 'Plunger vertical velocity', 0, 0);
model.physics('mf').feature('ge1').set('DependentVariableQuantity', 'velocity');
model.physics('mf').feature('ge1').set('SourceTermQuantity', 'acceleration');
model.physics('mf').create('ge2', 'GlobalEquations', -1);
model.physics('mf').feature('ge2').setIndex('name', 'dd', 0, 0);
model.physics('mf').feature('ge2').setIndex('equation', 'vv-ddt', 0, 0);
model.physics('mf').feature('ge2').setIndex('description', 'Plunger vertical displacement', 0, 0);
model.physics('mf').feature('ge2').set('DependentVariableQuantity', 'displacement');
model.physics('mf').feature('ge2').set('SourceTermQuantity', 'velocity');

model.variable.create('var1');
model.variable('var1').model('comp1');
model.variable('var1').set('at_bottom', 'dd<(-maxdisp)');
model.variable('var1').descr('at_bottom', 'Logical variable whose value is one when the plunger is at the bottom position');
model.variable('var1').set('disp', 'if(at_bottom, -maxdisp, dd)');
model.variable('var1').descr('disp', 'Plunger displacement');
model.variable('var1').set('vel', 'if(at_bottom, 0, vv)');
...
model.common('pres1').selection.named('uni1');
model.common('pres1').set('prescribedDeformation', {'0' '0' 'disp'});
...
model.common.create('disp2', 'PrescribedMeshDisplacement', 'comp1');
...
model.sol('sol2').feature('t1').feature('se1').feature('ss1').set('segvar', {'comp1_A' 'comp1_mf_psi' 'comp1_mf_coil1_ICoil_ode' 'comp1_ODE1' 'comp1_ODE2'});
...
model.sol('sol2').feature('t1').feature('se1').feature('ss1').label('Magnetic Fields');
model.sol('sol2').feature('t1').feature('se1').create('ss2', 'SegregatedStep');
model.sol('sol2').feature('t1').feature('se1').feature('ss2').set('segvar', {'comp1_spatial_disp'});
model.sol('sol2').feature('t1').feature('se1').feature('ss2').set('linsolver', 'dDef');
model.sol('sol2').feature('t1').feature('se1').feature('ss2').label('Spatial Frame Variables');
...
model.result('pg3').feature('mesh1').feature('sel1').selection.set([3 4 5 6 7 8 9 11 12 13 14 15 16 17 18 19 21 22 24 25]);
...
model.result('pg4').label('Out-of-Plane Current Density and Magnetic Flux Lines');
model.result('pg4').set('titletype', 'label');
model.result('pg4').set('frametype', 'spatial');
model.result('pg4').set('showlegendsmaxmin', true);
model.result('pg4').set('showlegendsunit', true);
model.result('pg4').create('surf1', 'Surface');
model.result('pg4').feature('surf1').set('expr', 'mf.Jy');
model.result('pg4').feature('surf1').set('unit', 'A/mm^2');
model.result('pg4').feature('surf1').set('rangecoloractive', true);
model.result('pg4').feature('surf1').set('rangecolormin', -2);
...
model.result('pg4').run;
model.result('pg4').feature('surf1').set('expr', 'mf.Jy*sign(mir1x)');
model.result('pg4').run;
model.result('pg4').run;
model.result('pg4').create('str1', 'Streamline');
model.result('pg4').feature('str1').set('expr', {'mf.Bx' 'mf.Bz'});
model.result('pg4').feature('str1').set('startmethod', 'coord');
model.result('pg4').feature('str1').set('xcoord', 'range(-0.018,0.004,0.018)');
model.result('pg4').feature('str1').set('ycoord', 0);
model.result('pg4').feature('str1').set('looptol', 0.1);
model.result('pg4').feature('str1').create('col1', 'Color');
model.result('pg4').run;
model.result('pg4').feature('str1').feature('col1').set('rangecoloractive', true);
model.result('pg4').feature('str1').feature('col1').set('rangecolormax', 2);
model.result('pg4').run;
...
model.result('pg5').label('Core Losses');
...
model.result('pg5').feature('str1').set('expr', {'mf.Jx' 'mf.Jy' 'mf.Jz'});
model.result('pg5').feature('str1').selection.set([97]);
model.result('pg5').run;
model.result('pg5').create('vol1', 'Volume');
model.result('pg5').feature('vol1').set('data', 'dset2');
model.result('pg5').feature('vol1').setIndex('looplevel', 11, 0);
model.result('pg5').feature('vol1').set('expr', 'mf.Qrh');
model.result('pg5').feature('vol1').set('unit', 'W/dm^3');
model.result('pg5').feature('vol1').set('colortable', 'GrayBody');
model.result('pg5').feature('vol1').create('sel1', 'Selection');
model.result('pg5').feature('vol1').feature('sel1').selection.named('geom1_pi1_ext1_dom');
model.result('pg5').run;
model.result('pg5').feature.duplicate('vol2', 'vol1');
model.result('pg5').run;
model.result('pg5').feature('vol2').setIndex('looplevel', 21, 0);
model.result('pg5').feature('vol2').create('trn1', 'Translation');
model.result('pg5').run;
model.result('pg5').feature('vol2').feature('trn1').set('trans', [-0.1 0 0]);
model.result('pg5').run;
model.result('pg5').feature('vol2').set('inheritplot', 'vol1');
model.result('pg5').feature.duplicate('vol3', 'vol2');
model.result('pg5').run;
model.result('pg5').feature('vol3').setIndex('looplevel', 23, 0);
model.result('pg5').run;
model.result('pg5').feature('vol3').feature('trn1').set('trans', [-0.2 0 0]);
model.result('pg5').run;
model.result('pg5').create('ann1', 'Annotation');
model.result('pg5').feature('ann1').set('text', '50 [ms]');
model.result('pg5').feature('ann1').set('posxexpr', 0.03);
model.result('pg5').feature('ann1').set('poszexpr', 0.07);
model.result('pg5').feature('ann1').set('showpoint', false);
model.result('pg5').run;
model.result('pg5').create('ann2', 'Annotation');
model.result('pg5').feature('ann2').set('text', '100 [ms]');
model.result('pg5').feature('ann2').set('posxexpr', -0.07);
model.result('pg5').feature('ann2').set('poszexpr', 0.07);
model.result('pg5').feature('ann2').set('showpoint', false);
model.result('pg5').run;
model.result('pg5').create('ann3', 'Annotation');
model.result('pg5').feature('ann3').set('text', '200 [ms]');
model.result('pg5').feature('ann3').set('posxexpr', -0.17);
model.result('pg5').feature('ann3').set('poszexpr', 0.07);
model.result('pg5').feature('ann3').set('showpoint', false);
...
model.result('pg5').run;
model.result('pg5').set('view', 'view9');
model.result('pg5').run;
model.result.create('pg6', 'PlotGroup1D');
model.result('pg6').run;
model.result('pg6').set('titletype', 'label');
model.result('pg6').label('Dynamics of the System Before Switching');
model.result('pg6').create('glob1', 'Global');
model.result('pg6').feature('glob1').set('markerpos', 'datapoints');
model.result('pg6').feature('glob1').set('linewidth', 'preference');
model.result('pg6').feature('glob1').set('data', 'dset2');
model.result('pg6').feature('glob1').setIndex('looplevelinput', 'interp', 0);
model.result('pg6').feature('glob1').setIndex('interp', 'range(0,0.005,0.05)', 0);
model.result('pg6').feature('glob1').setIndex('expr', 'mf.ICoil_1*mf.RCoil_1/mf.VCoil_1', 0);
model.result('pg6').feature('glob1').setIndex('descr', 'Current normalized to DC current', 0);
model.result('pg6').feature('glob1').setIndex('expr', '1+disp/maxdisp', 1);
model.result('pg6').feature('glob1').setIndex('descr', 'Normalized gap size', 1);
model.result('pg6').feature('glob1').setIndex('expr', '1-exp(-t/50[ms])', 2);
model.result('pg6').feature('glob1').setIndex('descr', 'Ideal RL normalized current', 2);
model.result('pg6').run;
model.result('pg6').run;
model.result.duplicate('pg7', 'pg6');
model.result('pg7').run;
model.result('pg7').label('Dynamics of the System During Switching');
model.result('pg7').run;
model.result('pg7').feature('glob1').setIndex('interp', 'range(0,0.005,0.1)', 0);
model.result('pg7').feature('glob1').setIndex('expr', '4*mass*d(vel,t)*vel/at(1,mf.ICoil_1*mf.VCoil_1)', 2);
model.result('pg7').feature('glob1').setIndex('descr', 'Mechanical power, normalized to DC coil power', 2);
model.result('pg7').run;
model.result('pg7').run;
model.result.duplicate('pg8', 'pg7');
model.result('pg8').run;
model.result('pg8').label('Dynamics of the Completed System');
model.result('pg8').set('legendpos', 'middleright');
model.result('pg8').set('ylabelactive', true);
model.result('pg8').run;
model.result('pg8').feature('glob1').setIndex('looplevelinput', 'all', 0);
model.result('pg8').feature('glob1').setIndex('expr', '', 2);
...
model.result('pg8').feature('glob2').setIndex('expr', '4*mf.Qrh/at(1,mf.ICoil_1*mf.VCoil_1)', 0);
model.result('pg8').feature('glob2').set('data', 'int1');
model.result('pg8').feature('glob2').setIndex('descr', 'Induction current losses, normalized to DC coil power', 0);
model.result('pg8').run;
model.result('pg5').run;
model.result('pg5').run;

model.title('Electrodynamics of a Power Switch');
