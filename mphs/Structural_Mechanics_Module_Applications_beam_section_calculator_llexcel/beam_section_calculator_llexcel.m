function out = model
%
% beam_section_calculator_llexcel.m
%
...
model.geom.load({'part2'}, 'Structural_Mechanics_Module/Beams/Generic/I_beam_generic.mph', {'part1'});
model.geom.load({'part3'}, 'Structural_Mechanics_Module/Beams/Generic/L_beam_generic.mph', {'part1'});
model.geom.load({'part4'}, 'Structural_Mechanics_Module/Beams/Generic/T_beam_generic.mph', {'part1'});
model.geom('geom1').lengthUnit('in');
model.geom('geom1').create('pi1', 'PartInstance');
model.geom('geom1').feature('pi1').set('selkeepnoncontr', false);
model.geom('geom1').feature('pi1').set('part', 'part2');
model.geom('geom1').feature('pi1').setEntry('inputexpr', 'd', '4.16[in]');
model.geom('geom1').feature('pi1').setEntry('inputexpr', 'b', '4.06[in]');
model.geom('geom1').feature('pi1').setEntry('inputexpr', 'tw', '0.28[in]');
model.geom('geom1').feature('pi1').setEntry('inputexpr', 'tf', '0.345[in]');
model.geom('geom1').feature('pi1').setEntry('inputexpr', 'r1', '0.25[in]');
model.geom('geom1').feature('pi1').setEntry('inputexpr', 'r2', 0);
model.geom('geom1').feature('pi1').setEntry('inputexpr', 'slope', 0);
model.geom('geom1').feature('pi1').setEntry('inputexpr', 'u', 0);
...
model.view('view6').camera.set('position', [14.6 10.7 32.7]);
model.view('view6').camera.setIndex('up', -0.11, 0);
model.view('view6').camera.setIndex('up', 0.96, 1);
model.view('view6').camera.set('up', [-0.11 0.96 -0.26]);
model.view('view6').camera.setIndex('viewoffset', '-5.48e-2', 0);
model.view('view6').camera.set('viewoffset', {'-5.48e-2' '2.72e-2'});

model.result('pg1').run;

model.title(['Beam Section Calculator (Using LiveLink' native2unicode(hex2dec({'21' '22'}), 'unicode') ' for Excel' native2unicode(hex2dec({'00' 'ae'}), 'unicode') ')']);

model.description(['This app demonstrates the following:' newline  newline  native2unicode(hex2dec({'20' '22'}), 'unicode') ' Reading and importing data from an Excel' native2unicode(hex2dec({'00' 'ae'}), 'unicode') '-file' newline  native2unicode(hex2dec({'20' '22'}), 'unicode') ' Exporting data to an Excel' native2unicode(hex2dec({'00' 'ae'}), 'unicode') '-file' newline  native2unicode(hex2dec({'20' '22'}), 'unicode') ' Light theme' newline  newline 'The app computes the beam section properties and true stress distribution in a designated steel beam section. A broad range of American and European beam standards are available. It uses LiveLink' native2unicode(hex2dec({'21' '22'}), 'unicode') ' for Excel' native2unicode(hex2dec({'00' 'ae'}), 'unicode') ' to read and store the beam data in Excel' native2unicode(hex2dec({'00' 'ae'}), 'unicode') ' worksheets.' newline  newline 'Requires the Structural Mechanics Module and LiveLink' native2unicode(hex2dec({'21' '22'}), 'unicode') ' for Excel' native2unicode(hex2dec({'00' 'ae'}), 'unicode') '.']);
