...
model.physics('dl1').feature('inl1').set('BoundaryCondition', 'Velocity');
...
model.sol('sol36').feature('s1').feature('se1').feature('ss1').set('linsolver', 'i1');
...
model.sol('sol36').feature('s1').feature('d1').label('Direct, heat transfer variables (ht1)');
model.sol('sol36').feature('s1').feature('se1').feature('ss2').set('linsolver', 'd1');
...
model.sol('sol36').feature('s1').feature('d2').label('Direct, concentrations (tds)');
model.sol('sol36').feature('s1').feature('se1').feature('ss3').set('linsolver', 'd2');
...
model.sol('sol36').feature('s1').feature('d3').label('Direct, pressure (dl1)');
...
model.sol('sol36').feature('s1').feature('i2').feature('mg1').set('compactaggregation', false);
...
model.result('pg8').feature('arws1').set('descr', 'Total Darcy velocity field');
