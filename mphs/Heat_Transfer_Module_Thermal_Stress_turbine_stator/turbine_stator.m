...
model.material('mat1').propertyGroup('def').set('INFO_PREFIX:thermalconductivity', ['Reference: Chromalloy Gas Turbine LLC. at http://www.chromalloy.com/' newline 'Note: calculated from the specific heat, thermal diffusivity and density, corrected for thermal expansion, solution heat-treated at 1121 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1394 K) for 2 h, aged at 843 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1116 K) for 24 h']);
model.material('mat1').propertyGroup('def').set('Syt', 'Syt(T)');
model.material('mat1').propertyGroup('def').set('INFO_PREFIX:Syt', ['Reference: Chromalloy Gas Turbine LLC. at http://www.chromalloy.com/' newline 'Note: tested at an unknown strain rate in tension, longitudinal direction, average of 2 samples, 0.05 in^2 (0.32 cm^2) cross-sectional area, spread in the measurements was approximately 10 MPa (1.45 ksi) at 427 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (700 K) and 120 MPa (17.4 ksi) at 982 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1255 K), solution heat-treated at 1121 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1394 K) for 2 h, aged at 843 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1116 K) for 24 h']);
...
model.material('mat1').propertyGroup('def').set('INFO_PREFIX:thermalexpansioncoefficient', ['Reference: Chromalloy Gas Turbine LLC. at http://www.chromalloy.com/' newline 'Note: the reference temperature is 20 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (293 K), solution heat-treated at 1121 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1394 K) for 2 h, aged at 843 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1116 K) for 24 h, calculated from the linear expansion' newline 'Reference temperature: 293.00[K]']);
model.material('mat1').propertyGroup('def').set('heatcapacity', 'C(T)');
model.material('mat1').propertyGroup('def').set('INFO_PREFIX:heatcapacity', ['Reference: Chromalloy Gas Turbine LLC. at http://www.chromalloy.com/' newline 'Note: average of 3 samples with a differential scanning calorimeter in argon ASTM E1269, heating rate was 20 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C/min, scatter in data was 3% at the highest temperatures, solution heat-treated at 1121 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1394 K) for 2 h, aged at 843 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1116 K) for 24 h']);
model.material('mat1').propertyGroup('def').set('density', 'rho(T)');
model.material('mat1').propertyGroup('def').set('INFO_PREFIX:density', ['Reference: Chromalloy Gas Turbine LLC. at http://www.chromalloy.com/' newline 'Note: solution heat-treated at 1121 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1394 K) for 2 h, aged at 843 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1116 K) for 24 h, calculated from the linear expansion and the room temperature density']);
model.material('mat1').propertyGroup('def').set('TD', 'TD(T)');
model.material('mat1').propertyGroup('def').set('INFO_PREFIX:TD', ['Reference: Chromalloy Gas Turbine LLC. at http://www.chromalloy.com/' newline 'Note: average of 3 samples with a differential scanning calorimeter in argon ASTM, scatter in data was 6%, solution heat-treated at 1121 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1394 K) for 2 h, aged at 843 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1116 K) for 24 h']);
model.material('mat1').propertyGroup('def').set('elong', 'elong(T)');
model.material('mat1').propertyGroup('def').set('INFO_PREFIX:elong', ['Reference: Chromalloy Gas Turbine LLC. at http://www.chromalloy.com/' newline 'Note: tested at an unknown strain rate in tension, longitudinal direction, average of 2 samples, 0.05 in^2 (0.32 cm^2) cross-sectional area, spread in the measurements was approximately 9% at 982 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1255 K), solution heat-treated at 1121 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1394 K) for 2 h, aged at 843 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1116 K) for 24 h']);
...
model.material('mat1').propertyGroup('ThermalExpansion').set('INFO_PREFIX:dL', ['Reference: Chromalloy Gas Turbine LLC. at http://www.chromalloy.com/' newline 'Note: the reference temperature is 20 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (293 K), average of 3 samples measured on heating, values on cooling were slightly different, push-rod dilatometer ASTM E228, measured in helium at a 2 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C/min heating rate, solution heat-treated at 1121 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1394 K) for 2 h, aged at 843 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1116 K) for 24 h' newline 'Reference temperature: 293.00[K]']);
...
model.material('mat1').propertyGroup('Enu').set('INFO_PREFIX:E', ['Reference: Chromalloy Gas Turbine LLC. at http://www.chromalloy.com/' newline 'Note: dynamic modulus in longitudinal direction, solution heat-treated at 1121 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1394 K) for 2 h, aged at 843 ' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C (1116 K) for 24 h']);
