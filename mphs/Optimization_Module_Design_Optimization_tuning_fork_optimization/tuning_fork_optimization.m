...
model.study('std2').feature('opt').setIndex('ubound', '', 0);
model.study('std2').feature('opt').setIndex('initval', '7.8[cm]', 0);
model.study('std2').feature('opt').setIndex('scale', '1[cm]', 0);
model.study('std2').feature('opt').setIndex('lbound', '7[cm]', 0);
model.study('std2').feature('opt').setIndex('ubound', '9[cm]', 0);
...
model.sol('sol19').create('e1', 'Eigenvalue');
model.sol('sol19').feature('e1').set('eigvfunscale', 'maximum');
model.sol('sol19').feature('e1').set('eigvfunscaleparam', '1.14E-7');
model.sol('sol19').feature('e1').set('control', 'eig');
model.sol('sol19').feature('e1').feature('aDef').set('cachepattern', true);
...
model.batch('p2').feature('so1').set('seq', 'sol19');
...
model.sol('sol20').study('std2');
model.sol('sol20').label('Parametric Solutions 2');

model.batch('p2').feature('so1').set('psol', 'sol20');
...
model.title('Optimization of a Tuning Fork');
...
model.label('tuning_fork_optimization.mph');
