...
model.title('Steady-State 2D Heat Transfer with Conduction');

model.description(['This is a benchmark problem for a 2D steady-state thermal analysis with convection to 0' native2unicode(hex2dec({'00' 'b0'}), 'unicode') 'C on two boundaries. The temperature field from the analysis is compared with a NAFEMS benchmark solution.']);
